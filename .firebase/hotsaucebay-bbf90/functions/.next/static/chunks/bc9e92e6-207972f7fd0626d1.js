...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [992],
  {
    4150: (e, t, n) => {
      ...
      function x(e = "Unexpected state") {
        let t = `FIRESTORE (${w}) INTERNAL ASSERTION FAILED: ` + e;
        throw (E(t), Error(t));
      }
      let S = {
        OK: "ok",
      ...
      class V {
                  ...
                  .then((t) =>
                    this.i !== e
                      ? (T(
                        ...
                        this.getToken())
                      : t
                        ? ("string" == typeof t.accessToken || x(),
                          new D(t.accessToken, this.currentUser))
                        : null,
                  )
        ...
        u() {
          ...
          return null === e || "string" == typeof e || x(), new y(e);
        }
      }
      class R {
        constructor(e, t, n) {
      ...
      class L {
        ...
        getToken() {
          return Promise.resolve(new R(this.l, this.h, this.P));
        }
        start(e, t) {
      ...
      class O {
        ...
        getToken() {
          if (this.V) return Promise.resolve(new M(this.V));
      ...
      class B {
        ...
        static max() {
          return new B(new q(0x3afff4417f, 0x3b9ac9ff));
        }
        constructor(e) {
          this.timestamp = e;
        }
      ...
      class z {
        constructor(e, t, n) {
          void 0 === t ? (t = 0) : t > e.length && x(),
            void 0 === n ? (n = e.length - t) : n > e.length - t && x(),
            (this.segments = e),
            (this.offset = t),
            (this.len = n);
        }
        ...
        static comparator(e, t) {
          ...
          for (let r = 0; r < n; r++) {
            let n = z.compareSegments(e.get(r), t.get(r));
            if (0 !== n) return n;
          }
          return Math.sign(e.length - t.length);
        }
        static compareSegments(e, t) {
          let n = z.isNumericId(e),
            r = z.isNumericId(t);
          return n && !r
            ? -1
            : !n && r
              ? 1
              : n && r
                ? z.extractNumericId(e).compare(z.extractNumericId(t))
                : e < t
                  ? -1
                  : e > t
                    ? 1
      ...
      class j extends z {
        ...
        static fromServerFormat(e) {
          ...
          if ((i(), s))
            throw new N(S.INVALID_ARGUMENT, "Unterminated ` in path: " + e);
          return new j(t);
        }
        static emptyPath() {
          return new j([]);
      ...
      class Q {
        ...
        static fromPath(e) {
          return new Q($.fromString(e));
        }
        static fromName(e) {
          return new Q($.fromString(e).popFirst(5));
        }
        static empty() {
          return new Q($.emptyPath());
        }
        get collectionGroup() {
      ...
      function X(e, t) {
        ...
        return new et(
          B.fromTimestamp(1e9 === r ? new q(n + 1, 0) : new q(n, r)),
          Q.empty(),
          t,
        );
      }
      ...
      class et {
        ...
        static min() {
          return new et(B.min(), Q.empty(), -1);
        }
        static max() {
          return new et(B.max(), Q.empty(), -1);
        }
      }
      function en(e, t) {
        ...
        return 0 !== n
          ? n
          : 0 !== (n = Q.comparator(e.documentKey, t.documentKey))
            ? n
            : P(e.largestBatchId, t.largestBatchId);
      }
      let er =
      ...
      async function es(e) {
        if (e.code !== S.FAILED_PRECONDITION || e.message !== er) throw e;
      ...
      class ea {
        ...
        wrapUserFunction(e) {
          try {
            let t = e();
            return t instanceof ea ? t : ea.resolve(t);
          } catch (e) {
            return ea.reject(e);
          }
        }
        wrapSuccess(e, t) {
          return e ? this.wrapUserFunction(() => e(t)) : ea.resolve(t);
        }
        wrapFailure(e, t) {
          return e ? this.wrapUserFunction(() => e(t)) : ea.reject(t);
        }
        static resolve(e) {
          return new ea((t, n) => {
            t(e);
        ...
        static or(e) {
          let t = ea.resolve(!1);
          for (let n of e) t = t.next((e) => (e ? ea.resolve(e) : n()));
          return t;
        }
        static forEach(e, t) {
          let n = [];
      ...
      class el {
        static open(e, t, n, r) {
          try {
            return new el(t, e.transaction(r, n));
          } catch (e) {
            throw new ed(t, e);
          }
        }
        constructor(e, t) {
          (this.action = e),
            ...
            (this.transaction.onabort = () => {
              t.error ? this.m.reject(new ed(e, t.error)) : this.m.resolve();
            }),
            (this.transaction.onerror = (t) => {
              let n = ey(t.target.error);
              this.m.reject(new ed(e, n));
            });
        }
        get p() {
        ...
        store(e) {
          return new em(this.transaction.objectStore(e));
        }
      }
      class eu {
        static delete(e) {
          return (
            T(eo, "Removing database:", e),
            eg(window.indexedDB.deleteDatabase(e)).toPromise()
          );
        }
        static D() {
          if (!(0, h.zW)()) return !1;
        ...
        static v() {
          ...
          return (
            void 0 !== f &&
            "YES" ===
              (null === (e = f.__PRIVATE_env) || void 0 === e ? void 0 : e.F)
          );
        }
        static M(e, t) {
          return e.store(t);
        ...
        async N(e) {
          return (
            this.db ||
              (T(eo, "Opening database:", this.name),
        ...
        async runTransaction(e, t, n, r) {
          ...
          for (;;) {
            ...
            try {
              ...
              let t = el.open(this.db, e, i ? "readonly" : "readwrite", n),
                s = r(t)
                  .next((e) => (t.S(), e))
                  .catch((e) => (t.abort(e), ea.reject(e)))
                  .toPromise();
              return s.catch(() => {}), await t.p, s;
            } catch (t) {
      ...
      class em {
        ...
        put(e, t) {
          ...
          return (
            void 0 !== t
              ? (T(eo, "PUT", this.store.name, e, t),
                (n = this.store.put(t, e)))
              : (T(eo, "PUT", this.store.name, "<auto-key>", e),
                (n = this.store.put(e))),
            eg(n)
          );
        }
        add(e) {
          return T(eo, "ADD", this.store.name, e, e), eg(this.store.add(e));
        }
        get(e) {
          return eg(this.store.get(e)).next(
            (t) => (
              void 0 === t && (t = null), T(eo, "GET", this.store.name, e, t), t
            ),
          );
        }
        delete(e) {
          return T(eo, "DELETE", this.store.name, e), eg(this.store.delete(e));
        }
        count() {
          return T(eo, "COUNT", this.store.name), eg(this.store.count());
        }
        G(e, t) {
        ...
        J(e, t) {
          T(eo, "DELETE ALL", this.store.name);
          let n = this.options(e, t);
          n.Y = !1;
          let r = this.cursor(n);
          ...
          return new ea((r, i) => {
            (e.onerror = (e) => {
              ...
              (e.onsuccess = (e) => {
                ...
                if (a instanceof ea) {
                  let e = a.catch((e) => (s.done(), ea.reject(e)));
                  n.push(e);
                }
          ...
          T(ew, `Scheduled in ${e}ms`),
            (this.task = this.asyncQueue.enqueueAfterDelay(
              ...
              async () => {
                this.task = null;
                try {
                  let e = await this.ee.ne();
                  T(ew, `Documents written: ${e}`);
                } catch (e) {
                  ef(e)
                    ? T(
                        ew,
      ...
      function eS(e) {
        ...
        if ((t >= 2 || x(), 2 === t))
          return (
            ("\x01" === e.charAt(0) && "\x01" === e.charAt(1)) || x(),
            $.emptyPath()
          );
        let n = t - 2,
          r = [],
      ...
      eT.ae = -1;
      let eN = "remoteDocuments",
        eC = "owner",
        eD = "owner",
        ek = "mutationQueues",
        eA = "mutations",
        eV = "batchId",
        eR = "userMutationsIndex",
        eL = ["userId", "batchId"],
        eM = {},
        eO = "documentMutations",
        eF = "remoteDocumentsV14",
        eP = ["prefixPath", "collectionGroup", "readTime", "documentId"],
        eU = "documentKeyIndex",
        eq = ["prefixPath", "collectionGroup", "documentId"],
        eB = "collectionGroupIndex",
        eK = ["collectionGroup", "readTime", "prefixPath", "documentId"],
        ez = "remoteDocumentGlobal",
        e$ = "remoteDocumentGlobalKey",
        eG = "targets",
        ej = "queryTargetsIndex",
        eQ = ["canonicalId", "targetId"],
        eH = "targetDocuments",
        eW = ["targetId", "path"],
        eY = "documentTargetsIndex",
        eZ = ["path", "targetId"],
        eJ = "targetGlobalKey",
        eX = "targetGlobal",
        e0 = "collectionParents",
        e1 = ["collectionId", "parent"],
        e2 = "clientMetadata",
        e5 = "bundles",
        e8 = "namedQueries",
        e3 = "indexConfiguration",
        e4 = "collectionGroupIndex",
        e6 = "indexState",
        e9 = ["indexId", "uid"],
        e7 = "sequenceNumberIndex",
        te = ["uid", "sequenceNumber"],
        tt = "indexEntries",
        tn = [
          "indexId",
          "uid",
        ...
        tr = "documentKeyIndex",
        ti = ["indexId", "uid", "orderedDocumentKey"],
        ts = "documentOverlays",
        ta = ["userId", "collectionPath", "documentId"],
        to = "collectionPathOverlayIndex",
        tl = ["userId", "collectionPath", "largestBatchId"],
        tu = "collectionGroupOverlayIndex",
        th = ["userId", "collectionGroup", "largestBatchId"],
        tc = "globals",
        td = [ek, eA, eO, eN, eG, eC, eX, eH, e2, ez, e0, e5, e8],
        tf = [...td, ts],
        tm = [ek, eA, eO, eF, eG, eC, eX, eH, e2, ez, e0, e5, e8, ts],
        tg = [...tm, e3, e6, tt],
        tp = [...tg, tc];
      class ty extends ei {
        constructor(e, t) {
      ...
      class tE {
        constructor(e, t) {
          (this.comparator = e), (this.root = t || tb.EMPTY);
        }
        insert(e, t) {
          return new tE(
            this.comparator,
            this.root
              ...
              .copy(null, null, tb.BLACK, null, null),
          );
        }
        remove(e) {
          return new tE(
        ...
        getIterator() {
          return new t_(this.root, null, this.comparator, !1);
        }
        getIteratorFrom(e) {
          return new t_(this.root, e, this.comparator, !1);
        }
        getReverseIterator() {
          return new t_(this.root, null, this.comparator, !0);
        }
        getReverseIteratorFrom(e) {
          return new t_(this.root, e, this.comparator, !0);
        }
      }
      class t_ {
        constructor(e, t, n, r) {
      ...
      class tb {
        constructor(e, t, n, r, i) {
          (this.key = e),
            (this.value = t),
            (this.color = null != n ? n : tb.RED),
            (this.left = null != r ? r : tb.EMPTY),
            (this.right = null != i ? i : tb.EMPTY),
        ...
        removeMin() {
          if (this.left.isEmpty()) return tb.EMPTY;
          let e = this;
          return (
        ...
        remove(e, t) {
          ...
          if (0 > t(e, r.key))
            ...
            if (
              ...
              if (r.right.isEmpty()) return tb.EMPTY;
              (n = r.right.min()),
        ...
        rotateLeft() {
          let e = this.copy(null, null, tb.RED, null, this.right.left);
          return this.right.copy(null, null, this.color, e, null);
        }
        rotateRight() {
          let e = this.copy(null, null, tb.RED, this.left.right, null);
      ...
      class tx {
        ...
        getIterator() {
          return new tS(this.data.getIterator());
        }
        getIteratorFrom(e) {
          return new tS(this.data.getIteratorFrom(e));
        }
        add(e) {
        ...
        isEqual(e) {
          if (!(e instanceof tx) || this.size !== e.size) return !1;
      ...
      class tC {
        ...
        isEqual(e) {
          return U(this.fields, e.fields, (e, t) => e.isEqual(t));
        }
      }
            ...
            (function (e) {
              try {
                ...
                throw "undefined" != typeof DOMException &&
                  ...
                  ? new tD("Invalid base64 string: " + e)
                  : e;
              }
            })(e),
          );
      ...
      tk.EMPTY_BYTE_STRING = new tk("");
      let tA = new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);
      function tV(e) {
        ...
        return { seconds: tR(e.seconds), nanos: tR(e.nanos) };
      }
      function tR(e) {
      ...
      function tL(e) {
        return "string" == typeof e
          ? tk.fromBase64String(e)
          : tk.fromUint8Array(e);
      }
      let tM = "server_timestamp",
        tO = "__type__",
        tF = "__previous_value__",
        tP = "__local_write_time__";
      function tU(e) {
        var t, n;
        return (
          (null ===
            ...
            void 0 === t
              ? void 0
              : t.fields) || {})[tO]) || void 0 === n
            ? void 0
            : n.stringValue) === tM
        );
      }
      function tq(e) {
        let t = e.mapValue.fields[tF];
        return tU(t) ? tq(t) : t;
      }
      function tB(e) {
        let t = tV(e.mapValue.fields[tP].timestampValue);
      ...
      class t$ {
        constructor(e, t) {
          (this.projectId = e), (this.database = t || tz);
        }
        static empty() {
          return new t$("", "");
        }
        get isDefaultDatabase() {
          return this.database === tz;
        }
        isEqual(e) {
          return (
            e instanceof t$ &&
      ...
      let tG = "__type__",
        tj = "__max__",
        tQ = { mapValue: { fields: { __type__: { stringValue: tj } } } },
        tH = "__vector__",
        tW = "value",
        tY = { nullValue: "NULL_VALUE" };
      function tZ(e) {
        ...
        switch (n) {
          ...
          case 3:
            return (function (e, t) {
              ...
              let n = tV(e.timestampValue),
                r = tV(t.timestampValue);
              return n.seconds === r.seconds && n.nanos === r.nanos;
            })(e, t);
          case 5:
            return e.stringValue === t.stringValue;
          case 6:
            return tL(e.bytesValue).isEqual(tL(t.bytesValue));
          case 7:
            return e.referenceValue === t.referenceValue;
          case 8:
            return (
              tR(e.geoPointValue.latitude) === tR(t.geoPointValue.latitude) &&
              tR(e.geoPointValue.longitude) === tR(t.geoPointValue.longitude)
            );
          case 2:
            return (function (e, t) {
              if ("integerValue" in e && "integerValue" in t)
                return tR(e.integerValue) === tR(t.integerValue);
              if ("doubleValue" in e && "doubleValue" in t) {
                let n = tR(e.doubleValue),
                  r = tR(t.doubleValue);
                return n === r ? e_(n) === e_(r) : isNaN(n) && isNaN(r);
              }
              return !1;
            })(e, t);
          case 9:
            return U(e.arrayValue.values || [], t.arrayValue.values || [], tJ);
          case 10:
          case 11:
            return (function (e, t) {
              let n = e.mapValue.fields || {},
                r = t.mapValue.fields || {};
              if (tv(n) !== tv(r)) return !1;
              for (let e in n)
                if (n.hasOwnProperty(e) && (void 0 === r[e] || !tJ(n[e], r[e])))
                  return !1;
              return !0;
            })(e, t);
          default:
      ...
      function tX(e, t) {
        return void 0 !== (e.values || []).find((e) => tJ(e, t));
      }
      function t0(e, t) {
        if (e === t) return 0;
        let n = tZ(e),
        ...
        switch (n) {
          ...
          case 2:
            return (function (e, t) {
              let n = tR(e.integerValue || e.doubleValue),
                r = tR(t.integerValue || t.doubleValue);
              return n < r
                ? -1
                : n > r
                  ? 1
          ...
          case 3:
            return t1(e.timestampValue, t.timestampValue);
          case 4:
            return t1(tB(e), tB(t));
          case 5:
            return P(e.stringValue, t.stringValue);
          case 6:
            return (function (e, t) {
              let n = tL(e),
                r = tL(t);
          ...
          case 8:
            return (function (e, t) {
              let n = P(tR(e.latitude), tR(t.latitude));
              return 0 !== n ? n : P(tR(e.longitude), tR(t.longitude));
            })(e.geoPointValue, t.geoPointValue);
          case 9:
            return t2(e.arrayValue, t.arrayValue);
          case 10:
            return (function (e, t) {
              var n, r, i, s;
              let a = e.fields || {},
                o = t.fields || {},
                l =
                  null === (n = a[tW]) || void 0 === n ? void 0 : n.arrayValue,
                u =
                  null === (r = o[tW]) || void 0 === r ? void 0 : r.arrayValue,
                h = P(
          ...
          case 11:
            return (function (e, t) {
              ...
              for (let e = 0; e < r.length && e < s.length; ++e) {
                let t = P(r[e], s[e]);
                if (0 !== t) return t;
                let a = t0(n[r[e]], i[s[e]]);
                if (0 !== a) return a;
              }
              return P(r.length, s.length);
            })(e.mapValue, t.mapValue);
          default:
            throw x();
        }
              ...
              : "doubleValue" in e
                ...
                : "timestampValue" in e
                  ...
                  : "stringValue" in e
                    ? e.stringValue
                    : "bytesValue" in e
                      ? tL(e.bytesValue).toBase64()
                      : "referenceValue" in e
                        ? ((t = e.referenceValue), Q.fromName(t).toString())
                        : "geoPointValue" in e
                          ? ((n = e.geoPointValue),
      ...
      function nt(e) {
        ...
        if (e.mapValue) {
          ...
          return (
            tI(e.mapValue.fields, (e, n) => (t.mapValue.fields[e] = nt(n))), t
          );
        }
        if (e.arrayValue) {
      ...
      function nn(e) {
        return (
          (((e.mapValue || {}).fields || {}).__type__ || {}).stringValue === tj
        );
      }
      let nr = {
        mapValue: {
          fields: { [tG]: { stringValue: tH }, [tW]: { arrayValue: {} } },
        },
      };
      function ni(e, t) {
        let n = t0(e.value, t.value);
        return 0 !== n
          ? n
      ...
      class na {
        ...
        field(e) {
          if (e.isEmpty()) return this.value;
          {
            ...
            for (let n = 0; n < e.length - 1; ++n)
              if (!t7((t = (t.mapValue.fields || {})[e.get(n)]))) return null;
        ...
        applyChanges(e, t, n) {
          for (let r of (tI(t, (t, n) => (e[t] = n)), n)) delete e[r];
        }
        clone() {
          return new na(nt(this.value));
        }
      }
      class no {
        ...
        static newInvalidDocument(e) {
          return new no(e, 0, B.min(), B.min(), B.min(), na.empty(), 0);
        }
        static newFoundDocument(e, t, n, r) {
          return new no(e, 1, t, B.min(), n, r, 0);
        }
        static newNoDocument(e, t) {
          return new no(e, 2, t, B.min(), B.min(), na.empty(), 0);
        }
        static newUnknownDocument(e, t) {
          return new no(e, 3, t, B.min(), B.min(), na.empty(), 2);
        }
        ...
        for (let i = 0; i < e.position.length; i++) {
          ...
          if (
            ((r = s.field.isKeyField()
              ? Q.comparator(Q.fromName(a.referenceValue), n.key)
              : t0(a, n.data.field(s.field))),
            "desc" === s.dir && (r *= -1),
            0 !== r)
          )
            break;
      ...
      function nh(e, t) {
        ...
        for (let n = 0; n < e.position.length; n++)
          if (!tJ(e.position[n], t.position[n])) return !1;
        return !0;
      }
      class nc {
        constructor(e, t = "asc") {
      ...
      class nf extends nd {
        ...
        static createKeyFieldInFilter(e, t, n) {
          return "in" === t ? new nT(e, n) : new nE(e, n);
        }
        matches(e) {
          let t = e.data.field(this.field);
          return "!=" === this.op
            ? null !== t && this.matchesComparison(t0(t, this.value))
            : null !== t &&
                tZ(this.value) === tZ(t) &&
                this.matchesComparison(t0(t, this.value));
        }
        matchesComparison(e) {
          switch (this.op) {
            case "<":
      ...
      function nw(e) {
        for (let t of e.filters) if (t instanceof nm) return !1;
        return !0;
      }
      function nv(e, t) {
        let n = e.filters.concat(t);
        return nm.create(n, e.op);
      }
      class nI extends nf {
        constructor(e, t, n) {
      ...
      class nT extends nf {
        constructor(e, t) {
          super(e, "in", t), (this.keys = n_("in", t));
        }
        matches(e) {
      ...
      class nE extends nf {
        constructor(e, t) {
          super(e, "not-in", t), (this.keys = n_("not-in", t));
        }
        matches(e) {
          return !this.keys.some((t) => t.isEqual(e.key));
        }
      ...
      class nb extends nf {
        ...
        matches(e) {
          let t = e.data.field(this.field);
          return t4(t) && tX(t.arrayValue, this.value);
        }
      }
      class nx extends nf {
        constructor(e, t) {
        ...
        matches(e) {
          let t = e.data.field(this.field);
          return null !== t && tX(this.value.arrayValue, t);
        }
      }
      class nS extends nf {
        constructor(e, t) {
        ...
        matches(e) {
          if (tX(this.value.arrayValue, { nullValue: "NULL_VALUE" })) return !1;
          let t = e.data.field(this.field);
          return null !== t && !tX(this.value.arrayValue, t);
        }
      }
      class nN extends nf {
        ...
        matches(e) {
          let t = e.data.field(this.field);
          return (
            !(!t4(t) || !t.arrayValue.values) &&
            t.arrayValue.values.some((e) => tX(this.value.arrayValue, e))
          );
        }
      }
      class nC {
      ...
      function nD(e, t = null, n = [], r = [], i = null, s = null, a = null) {
        return new nC(e, t, n, r, i, s, a);
      }
      function nk(e) {
        if (null === e.le) {
          ...
          null !== e.collectionGroup && (t += "|cg:" + e.collectionGroup),
            ...
            (t += e.filters
              .map((e) =>
                (function e(t) {
                  if (t instanceof nf)
                    return (
                      t.field.canonicalString() + t.op.toString() + t5(t.value)
                    );
                  if (ny(t)) return t.filters.map((t) => e(t)).join(",");
                  {
            ...
            e.startAt &&
              ...
              (t += e.startAt.position.map((e) => t5(e)).join(","))),
            e.endAt &&
              ((t += "|ub:"),
              (t += e.endAt.inclusive ? "a:" : "b:"),
              (t += e.endAt.position.map((e) => t5(e)).join(","))),
            (e.le = t);
        }
        return e.le;
      }
      ...
      function nR(e, t) {
        return e.filters.filter((e) => e instanceof nf && e.field.isEqual(t));
      }
      function nL(e, t, n) {
        let r = tY,
          i = !0;
        for (let n of nR(e, t)) {
          ...
          0 > ni({ value: r, inclusive: i }, { value: e, inclusive: t }) &&
            ((r = e), (i = t));
        }
        if (null !== n) {
      ...
      function nM(e, t, n) {
        ...
        for (let n of nR(e, t)) {
          ...
          ns({ value: r, inclusive: i }, { value: e, inclusive: t }) > 0 &&
            ((r = e), (i = t));
        }
        if (null !== n) {
          for (let s = 0; s < e.orderBy.length; ++s)
        ...
        if (null === e.he) {
          ...
          t).forEach((t) => {
            n.has(t.canonicalString()) ||
              t.isKeyField() ||
              e.he.push(new nc(t, r));
          }),
            n.has(j.keyField().canonicalString()) ||
              e.he.push(new nc(j.keyField(), r));
        }
        return e.he;
      }
      function nB(e) {
            ...
            (e.Pe = (function (e, t) {
                ...
                );
              {
                t = t.map((e) => {
                  ...
                  return new nc(e.field, t);
                });
                let n = e.endAt
                    ? new nl(e.endAt.position, e.endAt.inclusive)
                    : null,
                  r = e.startAt
                    ? new nl(e.startAt.position, e.startAt.inclusive)
                    : null;
                return nD(
                  e.path,
                  e.collectionGroup,
      ...
      function n$(e, t) {
        return nA(nB(e), nB(t)) && e.limitType === t.limitType;
      }
      function nG(e) {
        return `${nk(nB(e))}|lt:${e.limitType}`;
      }
      function nj(e) {
        var t;
        let n;
        return `Query(target=${
          ((n = (t = nB(e)).path.canonicalString()),
          ...
          t.filters.length > 0 &&
            (n += `, filters: [${t.filters
              .map((e) =>
                (function e(t) {
                  return t instanceof nf
                    ? `${t.field.canonicalString()} ${t.op} ${t5(t.value)}`
                    : t instanceof nm
                      ? t.op.toString() +
                        " {" +
          ...
          t.startAt &&
            ...
            (n += t.startAt.position.map((e) => t5(e)).join(","))),
          t.endAt &&
            ((n += ", endAt: "),
            (n += t.endAt.inclusive ? "a:" : "b:"),
            (n += t.endAt.position.map((e) => t5(e)).join(","))),
          `Target(${n})`)
      ...
      let nZ = new tE(Q.comparator),
        nJ = new tE(Q.comparator);
      function nX(...e) {
        let t = nJ;
      ...
      let n2 = new tE(Q.comparator),
        n5 = new tx(Q.comparator);
      function n8(...e) {
        let t = n5;
        for (let n of e) t = t.add(n);
        return t;
      ...
      function n4(e, t) {
        ...
        return { doubleValue: e_(t) ? "-0" : t };
      }
      function n6(e) {
        return { integerValue: "" + e };
      }
      function n9(e, t) {
        return eb(t) ? n6(t) : n4(e, t);
      }
      class n7 {
        constructor() {
          this._ = void 0;
      ...
      function rr(e, t) {
        let n = rl(t);
        for (let t of e.elements) n.some((e) => tJ(e, t)) || n.push(t);
      ...
      function rs(e, t) {
        let n = rl(t);
        for (let t of e.elements) n = n.filter((e) => !tJ(e, t));
        return { arrayValue: { values: n } };
      }
      class ra extends n7 {
        constructor(e, t) {
      ...
      function ro(e) {
        return tR(e.integerValue || e.doubleValue);
      }
      function rl(e) {
        return t4(e) && e.arrayValue.values ? e.arrayValue.values.slice() : [];
      }
      class ru {
        constructor(e, t) {
      ...
      function rm(e, t) {
        ...
        if (null === t)
          return e.isNoDocument()
            ? new rE(e.key, rc.none())
            : new ry(e.key, e.data, rc.none());
        {
          let n = e.data,
            r = na.empty(),
            i = new tx(j.comparator);
          ...
          return new rw(e.key, r, new tC(i.toArray()), rc.none());
        }
      }
      function rg(e, t, n, r) {
        return e instanceof ry
          ? (function (e, t, n, r) {
              if (!rd(e.precondition, t)) return n;
              let i = e.value.clone(),
                s = rT(e.fieldTransforms, r, t);
              return (
                i.setAll(s),
          ...
          : e instanceof rw
            ? (function (e, t, n, r) {
                if (!rd(e.precondition, t)) return n;
                let i = rT(e.fieldTransforms, r, t),
                  s = t.data;
                return (s.setAll(rv(e)),
                s.setAll(i),
            ...
            (!(!n || !r) &&
              U(n, r, (e, t) => {
                ...
                return (
                  ...
                  ((n = e.transform),
                  (r = t.transform),
                  (n instanceof rn && r instanceof rn) ||
                  (n instanceof ri && r instanceof ri)
                    ? U(n.elements, r.elements, tJ)
                    : n instanceof ra && r instanceof ra
                      ? tJ(n.Ie, r.Ie)
                      : n instanceof rt && r instanceof rt)
                );
              }))
          )) &&
          (0 === e.type
      ...
      function rI(e, t, n) {
        ...
        for (let s = 0; s < n.length; s++) {
          ...
          i.set(
            a.field,
            ((r = n[s]),
            o instanceof rn ? rr(o, l) : o instanceof ri ? rs(o, l) : r),
          );
        }
        return i;
      }
              ...
              : e instanceof rn
                ...
                : e instanceof ri
                  ...
                  : (function (e, t) {
                      let n = re(e, t),
                        r = ro(n) + ro(e.Ie);
                      return t3(n) && t3(e.Ie) ? n6(r) : n4(e.serializer, r);
                    })(e, s),
          );
        }
        return r;
            ...
            if (i.key.isEqual(e.key)) {
              ...
              (r = n[t]),
                i instanceof ry
                  ? (function (e, t, n) {
                      let r = e.value.clone(),
                        i = rI(e.fieldTransforms, t, n.transformResults);
                      r.setAll(i),
                        t
                  ...
                  : i instanceof rw
                    ? (function (e, t, n) {
                        if (!rd(e.precondition, t))
                          return void t.convertToUnknownDocument(n.version);
                        let r = rI(e.fieldTransforms, t, n.transformResults),
                          i = t.data;
                        i.setAll(rv(e)),
                          i.setAll(r),
                          t
          ...
          return (
            this.mutations.forEach((r) => {
              let i = e.get(r.key),
                ...
                o = rm(s, (a = t.has(r.key) ? null : a));
              null !== o && n.set(r.key, o),
                s.isValidDocument() || s.convertToNoDocument(B.min());
            }),
            n
          );
        }
        keys() {
          return this.mutations.reduce((e, t) => e.add(t.key), n8());
        }
        isEqual(e) {
          return (
            this.batchId === e.batchId &&
            U(this.mutations, e.mutations, (e, t) => rp(e, t)) &&
            U(this.baseMutations, e.baseMutations, (e, t) => rp(e, t))
          );
        }
      }
      class rx {
      ...
      function rC(e) {
        if (void 0 === e) return E("GRPC error has no .code"), S.UNKNOWN;
        switch (e) {
          case r.OK:
            return S.OK;
          case r.CANCELLED:
      ...
      let rD = new c.jz([0xffffffff, 0xffffffff], 0);
      function rk(e) {
      ...
      class rV {
        constructor(e, t, n) {
          ...
          if (n < 0 || (e.length > 0 && 0 === this.hashCount))
            throw new rR(`Invalid hash count: ${n}`);
          if (0 === e.length && 0 !== t)
            throw new rR(`Invalid padding when bitmap length is 0: ${t}`);
          (this.Ee = 8 * e.length - t), (this.de = c.jz.fromNumber(this.Ee));
        }
        Ae(e, t, n) {
      ...
      class rL {
        ...
        static createSynthesizedRemoteEventForCurrentChange(e, t, n) {
          let r = new Map();
          return (
            r.set(e, rM.createSynthesizedTargetChangeForCurrentChange(e, t, n)),
            new rL(B.min(), r, new tE(P), nZ, n8())
          );
        }
      }
      class rM {
      ...
      class rP {
        constructor(e, t, n = tk.EMPTY_BYTE_STRING, r = null) {
          (this.state = e),
            (this.targetIds = t),
            (this.resumeToken = n),
            (this.cause = r);
      ...
      class rU {
        ...
        Fe() {
          ...
          return (
            ...
            new rM(this.we, this.Se, e, t, n)
          );
        }
        Me() {
          (this.be = !1), (this.ye = rK());
        }
        xe(e, t) {
      ...
      class rq {
        ...
        Ze(e) {
          ...
          if (r) {
            ...
            if (nV(i)) {
              if (0 === n) {
                let e = new Q(i.path);
                this.ze(t, e, no.newNoDocument(e, B.min()));
              } else 1 === n || x();
            } else {
              let r = this.et(t);
              if (r !== n) {
        ...
        ot(e) {
          ...
          this.qe.forEach((n, r) => {
            let i = this.Xe(r);
            if (i) {
              if (n.current && nV(i.target)) {
                let t = new Q(i.target.path);
                this._t(t).has(r) ||
                  this.ut(r, t) ||
                  this.ze(r, t, no.newNoDocument(t, e));
              }
          ...
          let r = new rL(e, t, this.Ue, this.Qe, n);
          return (
            (this.Qe = nZ),
            (this.$e = rB()),
            (this.Ke = rB()),
        ...
        Ge(e, t) {
          if (!this.Je(e)) return;
          let n = this.ut(e, t.key) ? 2 : 0;
          this.He(e).xe(t.key, n),
        ...
        ze(e, t, n) {
          if (!this.Je(e)) return;
          let r = this.He(e);
          this.ut(e, t) ? r.xe(t, 1) : r.Oe(t),
            (this.Ke = this.Ke.insert(t, this.ct(t).delete(e))),
            (this.Ke = this.Ke.insert(t, this.ct(t).add(e))),
        ...
        He(e) {
          let t = this.qe.get(e);
          return t || ((t = new rU()), this.qe.set(e, t)), t;
        }
        ct(e) {
          let t = this.Ke.get(e);
          return t || ((t = new tx(P)), (this.Ke = this.Ke.insert(e, t))), t;
        }
        _t(e) {
          let t = this.$e.get(e);
          return t || ((t = new tx(P)), (this.$e = this.$e.insert(e, t))), t;
        }
        Je(e) {
          let t = null !== this.Xe(e);
          return (
            t || T("WatchChangeAggregator", "Detected inactive target", e), t
          );
        }
        Xe(e) {
          let t = this.qe.get(e);
      ...
      function rB() {
        return new tE(Q.comparator);
      }
      function rK() {
        return new tE(Q.comparator);
      }
      let rz = { asc: "ASCENDING", desc: "DESCENDING" },
        r$ = {
          "<": "LESS_THAN",
          "<=": "LESS_THAN_OR_EQUAL",
          ">": "GREATER_THAN",
      ...
      function rZ(e, t) {
        return rJ(e, t).canonicalString();
      }
      function rJ(e, t) {
        let n = new $(["projects", e.projectId, "databases", e.database]).child(
          "documents",
        );
      ...
      function r2(e, t) {
        return rZ(e.databaseId, t);
      }
      function r5(e) {
        let t = rX(e);
        return 4 === t.length ? $.emptyPath() : r3(t);
      }
      function r8(e) {
        return new $([
          "projects",
      ...
      function r3(e) {
        return (e.length > 4 && "documents" === e.get(4)) || x(), e.popFirst(5);
      }
      function r4(e, t, n) {
        return { name: r0(e, t), fields: n.value.mapValue.fields };
      }
      function r6(e, t, n) {
        let r = r1(e, t.name),
          i = rY(t.updateTime),
          s = t.createTime ? rY(t.createTime) : B.min(),
          a = new na({ mapValue: { fields: t.fields } }),
          o = no.newFoundDocument(r, i, s, a);
        return (
      ...
      function r9(e, t) {
        var n;
        let r;
        if (t instanceof ry) r = { update: r4(e, t.key, t.value) };
        else if (t instanceof rE) r = { delete: r0(e, t.key) };
        else if (t instanceof rw)
          r = {
            update: r4(e, t.key, t.data),
          ...
          t.precondition.isNone ||
            (r.currentDocument =
              void 0 !== (n = t.precondition).updateTime
                ? { updateTime: rH(e, n.updateTime.toTimestamp()) }
                : void 0 !== n.exists
                  ? { exists: n.exists }
                  : x()),
          r
      ...
      function r7(e, t) {
            ...
            ? t.updateTransforms.map((t) => {
                ...
                return (
                  ...
                  "setToServerValue" in t
                    ? ("REQUEST_TIME" === t.setToServerValue || x(),
                      (n = new rt()))
                    : "appendMissingElements" in t
                      ? (n = new rn(t.appendMissingElements.values || []))
                      : "removeAllFromArray" in t
                        ? (n = new ri(t.removeAllFromArray.values || []))
                        : "increment" in t
                          ? (n = new ra(e, t.increment))
                          : x(),
                  new ru(j.fromServerFormat(t.fieldPath), n)
                );
              })
            : [];
        if (t.update) {
          t.update.name;
          let n = r1(e, t.update.name),
            s = new na({ mapValue: { fields: t.update.fields } });
          return t.updateMask
            ? new rw(
                n,
                s,
        ...
        return t.delete
          ? new rE(r1(e, t.delete), r)
          : t.verify
            ? new r_(r1(e, t.verify), r)
            : x();
      }
      function ie(e, t) {
        return { documents: [r2(e, t.path)] };
      }
      function it(e, t) {
        var n, r;
        let i;
              ...
              return t instanceof nf
                ? (function (e) {
                    if ("==" === e.op) {
                      if (t9(e.value))
                        return {
                          unaryFilter: { field: ii(e.field), op: "IS_NAN" },
                        };
                      if (t6(e.value))
                        return {
                          unaryFilter: { field: ii(e.field), op: "IS_NULL" },
                        };
                    } else if ("!=" === e.op) {
                      if (t9(e.value))
                        return {
                          unaryFilter: { field: ii(e.field), op: "IS_NOT_NAN" },
                        };
                      if (t6(e.value))
                        return {
                          unaryFilter: {
                ...
                : t instanceof nm
                  ? (function (t) {
                      ...
                      return 1 === n.length
                        ? n[0]
                        : { compositeFilter: { op: rG[t.op], filters: n } };
                    })(t)
                  : x();
            })(nm.create(e, "and"));
        })(t.filters);
        ...
        let l = (function (e) {
          if (0 !== e.length)
            return e.map((e) => ({ field: ii(e.field), direction: rz[e.dir] }));
        })(t.orderBy);
      ...
      function ir(e) {
        ...
        i.where &&
          (o = (function (e) {
              ...
              return void 0 !== t.unaryFilter
                ? (function (e) {
                    switch (e.unaryFilter.op) {
                      case "IS_NAN":
                        let t = is(e.unaryFilter.field);
                        return nf.create(t, "==", { doubleValue: NaN });
                      case "IS_NULL":
                        let n = is(e.unaryFilter.field);
                        return nf.create(n, "==", { nullValue: "NULL_VALUE" });
                      case "IS_NOT_NAN":
                        let r = is(e.unaryFilter.field);
                        return nf.create(r, "!=", { doubleValue: NaN });
                      case "IS_NOT_NULL":
                        let i = is(e.unaryFilter.field);
                        return nf.create(i, "!=", { nullValue: "NULL_VALUE" });
                      default:
                        return x();
                    }
                  })(t)
            ...
            return t instanceof nm && ny(t) ? t.getFilters() : [t];
          })(i.where));
        let l = [];
        i.orderBy &&
          (l = i.orderBy.map(
        ...
        i.limit &&
          (u =
            null == (n = "object" == typeof (t = i.limit) ? t.value : t)
              ? null
              : n);
        let h = null;
        i.startAt &&
      ...
      function iu(e, t) {
        let n = t.key,
          r = {
            ...
            readTime: ih(t.readTime),
            hasCommittedMutations: t.hasCommittedMutations,
          };
        if (t.isFoundDocument()) {
          var i;
          r.document = {
            name: r0((i = e.Tt), t.key),
            fields: t.data.value.mapValue.fields,
            updateTime: rH(i, t.version.toTimestamp()),
            createTime: rH(i, t.createTime.toTimestamp()),
          };
        } else if (t.isNoDocument())
          r.noDocument = { path: n.path.toArray(), readTime: ic(t.version) };
        else {
          if (!t.isUnknownDocument()) return x();
          r.unknownDocument = {
            path: n.path.toArray(),
            version: ic(t.version),
          };
        }
        return r;
      }
      ...
      function id(e) {
        let t = new q(e.seconds, e.nanoseconds);
        return B.fromTimestamp(t);
      }
      function im(e, t) {
        let n = (t.baseMutations || []).map((t) => r7(e.Tt, t));
        ...
        let r = t.mutations.map((t) => r7(e.Tt, t)),
          i = q.fromMillis(t.localWriteTimeMs);
        return new rb(t.batchId, i, n, r);
      }
      function ig(e) {
        var t;
        let n = id(e.readTime),
          r =
            void 0 !== e.lastLimboFreeSnapshotVersion
              ? id(e.lastLimboFreeSnapshotVersion)
              : B.min();
        return new io(
          void 0 !== e.query.documents
            ? (1 === (t = e.query).documents.length || x(),
              nB(nF(r5(t.documents[0]))))
            : nB(ir(e.query)),
          e.targetId,
          "TargetPurposeListen",
          ...
          n,
          r,
          tk.fromBase64String(e.resumeToken),
        );
      }
      function ip(e, t) {
        let n;
        let r = ic(t.snapshotVersion),
          i = ic(t.lastLimboFreeSnapshotVersion);
        n = nV(t.target) ? ie(e.Tt, t.target) : it(e.Tt, t.target).ht;
        let s = t.resumeToken.toBase64();
        return {
          targetId: t.targetId,
          canonicalId: nk(t.target),
          readTime: r,
          resumeToken: s,
      ...
      function iy(e) {
        ...
        return "LAST" === e.limitType ? nz(t, t.limit, "L") : t;
      }
      function iw(e, t) {
        return new rS(t.largestBatchId, r7(e.Tt, t.overlayMutation));
      }
      function iv(e, t) {
        let n = t.path.lastSegment();
        return [e, ex(t.path.popLast()), n];
      }
      function iI(e, t, n, r) {
        return {
          indexId: e,
          uid: t,
          sequenceNumber: n,
          readTime: ic(r.readTime),
          documentKey: ex(r.documentKey.path),
          ...
          return tw(e, e8)
            ...
            .next((e) => {
              if (e)
                return {
                  name: e.name,
                  query: iy(e.bundledQuery),
                  readTime: id(e.readTime),
                };
            });
        }
        saveNamedQuery(e, t) {
      ...
      class iE {
        ...
        static It(e, t) {
          return new iE(e, t.uid || "");
        }
        getOverlay(e, t) {
          return tw(e, ts)
            .get(iv(this.userId, t))
            .next((e) => (e ? iw(this.serializer, e) : null));
        }
        getOverlays(e, t) {
          let n = n1();
          return ea
        ...
        removeOverlaysForBatchId(e, t, n) {
          let r = new Set();
          t.forEach((e) => r.add(ex(e.getCollectionPath())));
          let i = [];
          return (
            r.forEach((t) => {
        ...
        getOverlaysForCollectionGroup(e, t, n, r) {
          ...
          return tw(e, ts)
            .Z({ index: tu, range: a }, (e, t, n) => {
              let a = iw(this.serializer, t);
          ...
          return tw(e, ts).put(
            (function (e, t, n) {
              ...
              return {
                ...
                overlayMutation: r9(e.Tt, n.mutation),
              };
        ...
        getSessionToken(e) {
          return this.dt(e)
            ...
            .next((e) => {
              ...
              return t ? tk.fromUint8Array(t) : tk.EMPTY_BYTE_STRING;
            });
        }
        setSessionToken(e, t) {
      ...
      class ib {
        ...
        Rt(e, t) {
          if ("nullValue" in e) this.ft(t, 5);
            ...
            this.ft(t, 15), t.gt(tR(e.integerValue));
          else if ("doubleValue" in e) {
            let n = tR(e.doubleValue);
            isNaN(n)
              ? this.ft(t, 13)
              : (this.ft(t, 15), e_(n) ? t.gt(0) : t.gt(n));
          } else if ("timestampValue" in e) {
            let n = e.timestampValue;
            this.ft(t, 20),
              "string" == typeof n && (n = tV(n)),
              t.yt(`${n.seconds || ""}`),
              t.gt(n.nanos || 0);
          } else if ("stringValue" in e) this.wt(e.stringValue, t), this.St(t);
          else if ("bytesValue" in e)
            this.ft(t, 30), t.bt(tL(e.bytesValue)), this.St(t);
        ...
        Ct(e, t) {
          let n = e.fields || {};
          for (let e of (this.ft(t, 55), Object.keys(n)))
            this.wt(e, t), this.Rt(n[e], t);
        }
        vt(e, t) {
          var n, r;
          let i = e.fields || {};
          ...
          let s =
            (null ===
              (r =
                null === (n = i[tW].arrayValue) || void 0 === n
                  ? void 0
                  : n.values) || void 0 === r
              ? void 0
              : r.length) || 0;
          this.ft(t, 15), t.gt(tR(s)), this.wt(tW, t), this.Rt(i[tW], t);
        }
        Ft(e, t) {
          let n = e.values || [];
          for (let e of (this.ft(t, 50), n)) this.Rt(e, t);
        }
        Dt(e, t) {
          this.ft(t, 37),
        ...
        Qt(e) {
          for (let t of e) {
            ...
            if (e < 128) this.Nt(e);
              ...
              this.Nt(960 | (e >>> 6)), this.Nt(128 | (63 & e));
            else if (t < "\ud800" || "\udbff" < t)
              this.Nt(480 | (e >>> 12)),
                this.Nt(128 | (63 & (e >>> 6))),
                this.Nt(128 | (63 & e));
        ...
        $t(e) {
          for (let t of e) {
            ...
            if (e < 128) this.kt(e);
              ...
              this.kt(960 | (e >>> 6)), this.kt(128 | (63 & e));
            else if (t < "\ud800" || "\udbff" < t)
              this.kt(480 | (e >>> 12)),
                this.kt(128 | (63 & (e >>> 6))),
                this.kt(128 | (63 & e));
      ...
      class iD {
        constructor() {
          (this.Zt = new iS()),
            (this.Xt = new iN(this.Zt)),
            (this.en = new iC(this.Zt));
        }
        seed(e) {
          this.Zt.seed(e);
        }
        ...
        nn() {
          ...
          return (
            ...
            t !== e
              ...
              : ++n[n.length - 1],
            new ik(this.indexId, this.documentKey, this.arrayValue, n)
          );
        }
      }
      function iA(e, t) {
        ...
        return 0 !== n
          ? n
          : 0 !== (n = iV(e.arrayValue, t.arrayValue))
            ? n
            : 0 !== (n = iV(e.directionalValue, t.directionalValue))
              ? n
              : Q.comparator(e.documentKey, t.documentKey);
      }
      function iV(e, t) {
      ...
      class iR {
        constructor(e) {
          for (let t of ((this.rn = new tx((e, t) =>
            j.comparator(e.field, t.field),
          )),
          (this.collectionId =
            null != e.collectionGroup
              ? e.collectionGroup
          ...
          (this._n = []),
          e.filters))
            t.isInequality() ? (this.rn = this.rn.add(t)) : this._n.push(t);
        }
        get an() {
          return this.rn.size > 1;
        }
        un(e) {
          if ((e.collectionGroup === this.collectionId || x(), this.an))
            return !1;
          let t = W(e);
          ...
          if (this.rn.size > 0) {
            let e = this.rn.getIterator().getNext();
        ...
        Pn() {
          ...
          let e = new tx(j.comparator),
            t = [];
          for (let n of this._n)
            if (!n.field.isKeyField()) {
              if ("array-contains" === n.op || "array-contains-any" === n.op)
                t.push(new Z(n.field, 2));
              else {
                if (e.has(n.field)) continue;
                (e = e.add(n.field)), t.push(new Z(n.field, 0));
              }
            }
          for (let n of this.sn)
            n.field.isKeyField() ||
              e.has(n.field) ||
              ((e = e.add(n.field)),
              t.push(new Z(n.field, "asc" === n.dir ? 0 : 1)));
          return new H(H.UNKNOWN_ID, this.collectionId, t, J.empty());
        }
        cn(e) {
          for (let t of this._n) if (this.ln(t, e)) return !0;
          return !1;
        }
        ln(e, t) {
      ...
      function iO(e) {
        return (
          ...
          iM(e) ||
          (function (e) {
            if (e instanceof nm && np(e)) {
              for (let t of e.getFilters()) if (!iL(t) && !iM(t)) return !1;
              return !0;
            }
            return !1;
          })(e)
      ...
      function iF(e, t) {
        return (
          e instanceof nf || e instanceof nm || x(),
          t instanceof nf || t instanceof nm || x(),
          iU(
            e instanceof nf
              ? t instanceof nf
                ? nm.create([e, t], "and")
              ...
              : t instanceof nf
                ...
                : (function (e, t) {
                    if (
                      ((e.filters.length > 0 && t.filters.length > 0) || x(),
                      ng(e) && ng(t))
                    )
                      return nv(e, t.getFilters());
                    let n = np(e) ? e : t,
                      r = np(e) ? t : e,
                      i = n.filters.map((e) => iF(e, r));
                    return nm.create(i, "or");
                  })(e, t),
          )
        );
      }
      function iP(e, t) {
        if (ng(t)) return nv(t, e.getFilters());
        {
          let n = t.filters.map((t) => iF(e, t));
          return nm.create(n, "or");
        }
      }
      function iU(e) {
        if ((e instanceof nf || e instanceof nm || x(), e instanceof nf))
          return e;
        let t = e.getFilters();
        if (1 === t.length) return iU(t[0]);
        if (nw(e)) return e;
        let n = t.map((e) => iU(e)),
          r = [];
        return (
          ...
          1 === r.length ? r[0] : nm.create(r, e.op)
        );
      }
      class iq {
        constructor() {
        ...
        addToCollectionParentIndex(e, t) {
          return this.Tn.add(t), ea.resolve();
        }
        getCollectionParents(e, t) {
          return ea.resolve(this.Tn.getEntries(t));
        }
        addFieldIndex(e, t) {
          return ea.resolve();
        }
      ...
      class iB {
        ...
        add(e) {
          let t = e.lastSegment(),
            n = e.popLast(),
            r = this.index[t] || new tx($.comparator),
            i = !r.has(n);
        ...
        getEntries(e) {
          return (this.index[e] || new tx($.comparator)).toArray();
        }
      }
      ...
      class i$ {
        ...
        addToCollectionParentIndex(e, t) {
          if (!this.In.has(t)) {
            ...
            let i = { collectionId: n, parent: ex(r) };
            return tw(e, e0).put(i);
          }
          return ea.resolve();
        }
        getCollectionParents(e, t) {
              ...
              if (r) {
                ...
                return ea
                  .forEach(i, (i, s) => {
                    T(
                      iK,
                      `Using index id=${i.indexId}|cg=${i.collectionGroup}|f=${i.fields.map((e) => `${e.fieldPath}:${e.kind}`).join(",")} to execute ${nk(t)}`,
                    );
                    let a = (function (e, t) {
                        let n = W(t);
                        if (void 0 === n) return null;
                        for (let t of nR(e, n.fieldPath))
                          switch (t.op) {
                      ...
                      l = (function (e, t) {
                        ...
                        for (let i of Y(t)) {
                          let t =
                            0 === i.kind
                              ? nL(e, i.fieldPath, e.startAt)
                              : nM(e, i.fieldPath, e.startAt);
                      ...
                      u = (function (e, t) {
                        ...
                        for (let i of Y(t)) {
                          let t =
                            0 === i.kind
                              ? nM(e, i.fieldPath, e.endAt)
                              : nL(e, i.fieldPath, e.endAt);
                          n.push(t.value), r && (r = t.inclusive);
                        }
                        return new nl(n, r);
                      })(s, i),
                    ...
                    return ea.forEach(f, (i) =>
                      n.H(i, t.limit).next((t) => {
                        t.forEach((t) => {
                          let n = Q.fromSegments(t.documentKey);
                  ...
                  : (function (e) {
                      ...
                      let t = (function e(t) {
                        ...
                        return iO((r = iU(r)))
                          ...
                          : (r instanceof nm || x(),
                            ng(r) || x(),
                            r.filters.length > 1 || x(),
                            r.filters.reduce((e, t) => iF(e, t)));
                      })(
                        (function e(t) {
                          var n, r;
                          if (
                            ...
                            if (t instanceof nx) {
                              ...
                              return nm.create(e, "or");
                            }
                            return t;
                          }
                          let i = t.filters.map((t) => e(t));
                          return nm.create(i, t.op);
                        })(e),
                      );
                      return (
                        iO(t) || x(), iL(t) || iM(t) ? [t] : t.getFilters()
                      );
                    })(nm.create(e.filters, "and")).map((t) =>
                      nD(
                        e.path,
                        e.collectionGroup,
                        e.orderBy,
        ...
        mn(e, t, n, r, i, s, a) {
          let o = (null != t ? t.length : 1) * Math.max(n.length, i.length),
            ...
            u = [];
          for (let h = 0; h < o; ++h) {
            let o = t ? this.fn(t[h / l]) : iz,
              c = this.gn(e, o, n[h % l], r),
              d = this.pn(e, o, i[h % l], s),
              f = a.map((t) => this.gn(e, o, t, !0));
            u.push(...this.createRange(c, d, f));
          }
          return u;
        }
        gn(e, t, n, r) {
          let i = new ik(e, Q.empty(), t, n);
          return r ? i : i.nn();
        }
        pn(e, t, n, r) {
          let i = new ik(e, Q.empty(), t, n);
        ...
        fn(e) {
          let t = new iD();
          return ib.xt.At(e, t.tn(0)), t.Yt();
        }
        wn(e, t) {
          let n = new iD();
          return (
            ib.xt.At(
              t8(this.databaseId, t),
              n.tn(
                (function (e) {
                  let t = Y(e);
        ...
        Vn(e, t, n) {
          ...
          for (let s of Y(e)) {
            let e = n[i++];
            for (let n of r)
              if (this.Sn(t, s.fieldPath) && t4(e)) r = this.bn(r, s, e);
              else {
                let t = n.tn(s.kind);
                ib.xt.At(e, t);
              }
        ...
        bn(e, t, n) {
          ...
          for (let e of n.arrayValue.values || [])
            for (let n of r) {
              let r = new iD();
              r.seed(n.Yt()), ib.xt.At(e, r.tn(t.kind)), i.push(r);
            }
          return i;
        }
        Sn(e, t) {
        ...
        getFieldIndexes(e, t) {
          let n = tw(e, e3),
            r = tw(e, e6);
          return (t ? n.G(e4, IDBKeyRange.bound(t, t)) : n.G()).next((e) => {
            let t = [];
            return ea
              .forEach(e, (e) =>
                    ...
                    (function (e, t) {
                      let n = t
                          ? new J(
                              ...
                              new et(
                                id(t.readTime),
                                new Q(eS(t.documentKey)),
                                t.largestBatchId,
                              ),
                            )
                          : J.empty(),
                        r = e.fields.map(
                          ([e, t]) => new Z(j.fromServerFormat(e), t),
                        );
                      return new H(e.indexId, e.collectionGroup, r, n);
                    })(e, n),
                  );
                }),
              )
          ...
          return this.getFieldIndexes(e).next((e) =>
            0 === e.length
              ...
              : (e.sort((e, t) => {
                  ...
                  return 0 !== n ? n : P(e.collectionGroup, t.collectionGroup);
                }),
                e[0].collectionGroup),
          );
        }
        updateCollectionGroup(e, t, n) {
          ...
          return this.vn(e).next((e) =>
            r
              .G(e4, IDBKeyRange.bound(t, t))
              .next((t) =>
                ea.forEach(t, (t) => i.put(iI(t.indexId, this.uid, e, n))),
              ),
          );
        }
        updateIndexEntries(e, t) {
          let n = new Map();
          return ea.forEach(t, (t, r) => {
            let i = n.get(t.collectionGroup);
            return (
              i ? ea.resolve(i) : this.getFieldIndexes(e, t.collectionGroup)
            ).next(
              (i) => (
                n.set(t.collectionGroup, i),
                ea.forEach(i, (n) =>
                  this.Cn(e, t, n).next((t) => {
                    let i = this.Fn(r, n);
                    return t.isEqual(i) ? ea.resolve() : this.Mn(e, r, n, t, i);
                  }),
                )
              ),
            );
        ...
        Cn(e, t, n) {
          ...
          return r
            .Z(
              ...
              (e, r) => {
                i = i.add(
                  new ik(n.indexId, t, r.arrayValue, r.directionalValue),
                );
              },
            )
            .next(() => i);
          ...
          if (null != i) {
            ...
            if (t4(s))
              for (let i of s.arrayValue.values || [])
                n = n.add(new ik(t.indexId, e.key, this.fn(i), r));
          } else n = n.add(new ik(t.indexId, e.key, iz, r));
          return n;
        }
        Mn(e, t, n, r, i) {
          T(iK, "Updating index entries for document '%s'", t.key);
          let s = [];
          return (
            (function (e, t, n, r, i) {
              let s = e.getIterator(),
        ...
        createRange(e, t, n) {
          n = n
            .sort((e, t) => iA(e, t))
            .filter((e, t, n) => !t || 0 !== iA(e, n[t - 1]));
          let r = [];
          for (let i of (r.push(e), n)) {
            let n = iA(i, e),
              s = iA(i, t);
            if (0 === n) r[0] = e.nn();
            else if (n > 0 && s < 0) r.push(i), r.push(i.nn());
            else if (s > 0) break;
          }
          r.push(t);
          let i = [];
        ...
        getMinOffsetFromCollectionGroup(e, t) {
          return this.getFieldIndexes(e, t).next(iG);
        }
        getMinOffset(e, t) {
          return ea
            .mapArray(this.dn(t), (t) => this.An(e, t).next((e) => e || x()))
            .next(iG);
        }
      }
      function iG(e) {
        ...
        return new et(t.readTime, t.documentKey, n);
      }
      let ij = {
        didRun: !1,
      ...
      class iQ {
        static withCacheSize(e) {
          return new iQ(
            e,
            iQ.DEFAULT_COLLECTION_PERCENTILE,
            iQ.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT,
          );
        }
        constructor(e, t, n) {
      ...
      function iH(e, t, n) {
        let r = e.store(eA),
          ...
          o = 0,
          l = r.Z({ range: a }, (e, t, n) => (o++, n.delete()));
        s.push(
          l.next(() => {
            1 === o || x();
          }),
        ...
        for (let e of n.mutations) {
          var h, c;
          let r = ((h = e.key.path), (c = n.batchId), [t, ex(h), c]);
          s.push(i.delete(r)), u.push(e.key);
        }
        return ea.waitFor(s).next(() => u);
      }
      function iW(e) {
        let t;
        if (!e) return 0;
        if (e.document) t = e.document;
          ...
          if (!e.noDocument) throw x();
          t = e.noDocument;
        }
        return JSON.stringify(t).length;
      }
      (iQ.DEFAULT_COLLECTION_PERCENTILE = 10),
        (iQ.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT = 1e3),
        (iQ.DEFAULT = new iQ(
          0x2800000,
          iQ.DEFAULT_COLLECTION_PERCENTILE,
          iQ.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT,
        )),
        (iQ.DISABLED = new iQ(-1, 0, 0));
      class iY {
        constructor(e, t, n, r) {
          (this.userId = e),
            (this.serializer = t),
        ...
        static It(e, t, n, r) {
          return (
            "" !== e.uid || x(),
            new iY(e.isAuthenticated() ? e.uid : "", t, n, r)
          );
        }
        checkEmpty(e) {
          let t = !0,
        ...
        addMutationBatch(e, t, n, r) {
          ...
          return s.add({}).next((a) => {
            "number" == typeof a || x();
            let o = new rb(a, t, n, r),
              l = (function (e, t, n) {
                let r = n.baseMutations.map((t) => r9(e.Tt, t)),
                  i = n.mutations.map((t) => r9(e.Tt, t));
                return {
                  userId: t,
                  batchId: n.batchId,
              ...
              u = [],
              h = new tx((e, t) => P(e.canonicalString(), t.canonicalString()));
            for (let e of r) {
              let t = [this.userId, ex(e.key.path), a];
        ...
        lookupMutationBatch(e, t) {
          return iJ(e)
            ...
            .next((e) =>
              e
                ? (e.userId === this.userId || x(), im(this.serializer, e))
                : null,
            );
        }
        Ln(e, t) {
          return this.Bn[t]
            ? ea.resolve(this.Bn[t])
        ...
        getNextMutationBatchAfterBatchId(e, t) {
          let n = t + 1,
            ...
            i = null;
          return iJ(e)
            .Z({ index: eR, range: r }, (e, t, r) => {
              t.userId === this.userId &&
                (t.batchId >= n || x(), (i = im(this.serializer, t))),
                r.done();
            })
            .next(() => i);
        }
        getHighestUnacknowledgedBatchId(e) {
          let t = IDBKeyRange.upperBound([
            ...
            n = -1;
          return iJ(e)
            .Z({ index: eR, range: t, reverse: !0 }, (e, t, r) => {
              (n = t.batchId), r.done();
            })
            .next(() => n);
        }
        getAllMutationBatches(e) {
          ...
          return iJ(e)
            .G(eR, t)
            .next((e) => e.map((e) => im(this.serializer, e)));
        }
        getAllMutationBatchesAffectingDocumentKey(e, t) {
          let n = [this.userId, ex(t.path)],
            ...
            .Z({ range: r }, (n, r, s) => {
              ...
              if (a === this.userId && t.path.isEqual(u))
                return iJ(e)
                  ...
                  .next((e) => {
                    if (!e) throw x();
                    e.userId === this.userId || x(),
                      i.push(im(this.serializer, e));
                  });
              s.done();
            })
            .next(() => i);
        ...
        getAllMutationBatchesAffectingDocumentKeys(e, t) {
          ...
          return (
            t.forEach((t) => {
              let i = [this.userId, ex(t.path)],
                s = IDBKeyRange.lowerBound(i),
                a = tw(e, eO).Z({ range: s }, (e, r, i) => {
                  let [s, a, o] = e,
                    l = eS(a);
        ...
        removeMutationBatch(e, t) {
          return iH(e.ue, this.userId, t).next(
            (n) => (
              e.addOnCommittedListener(() => {
                this.qn(t.batchId);
              }),
      ...
      class i0 {
        ...
        allocateTargetId(e) {
          return this.Wn(e).next((t) => {
            let n = new iX(t.highestTargetId);
            return (
              (t.highestTargetId = n.next()),
              this.Gn(e, t).next(() => t.highestTargetId)
            );
          });
        }
        ...
        addTargetData(e, t) {
          return this.zn(e, t).next(() =>
            this.Wn(e).next(
              (n) => ((n.targetCount += 1), this.jn(t, n), this.Gn(e, n)),
            ),
          );
        }
        ...
        removeTargetData(e, t) {
          return this.removeMatchingKeysForTargetId(e, t.targetId)
            .next(() => tw(e, eG).delete(t.targetId))
            .next(() => this.Wn(e))
            .next(
              (t) => (
                t.targetCount > 0 || x(), (t.targetCount -= 1), this.Gn(e, t)
              ),
            );
        }
        removeTargets(e, t, n) {
        ...
        Gn(e, t) {
          return tw(e, eX).put(eJ, t);
        }
        zn(e, t) {
          return tw(e, eG).put(ip(this.serializer, t));
        }
        jn(e, t) {
          let n = !1;
          return (
        ...
        getTargetData(e, t) {
          let n = nk(t),
            ...
            i = null;
          return tw(e, eG)
            .Z({ range: r, index: ej }, (e, n, r) => {
              let s = ig(n);
              nA(t, s.target) && ((i = s), r.done());
            })
            .next(() => i);
        }
        ...
        containsKey(e, t) {
          let n = ex(t.path),
            ...
            i = 0;
          return i1(e)
            .Z({ index: eY, Y: !0, range: r }, ([e, t], n, r) => {
              0 !== e && (i++, r.done());
            })
            .next(() => i > 0);
        }
      ...
      class i8 {
        constructor(e) {
          (this.Hn = e), (this.buffer = new tx(i5)), (this.Jn = 0);
        }
        Yn() {
          return ++this.Jn;
        }
        Zn(e) {
          ...
          if (this.buffer.size < this.Hn) this.buffer = this.buffer.add(t);
            ...
            0 > i5(t, e) && (this.buffer = this.buffer.delete(e).add(t));
          }
        }
        get maxValue() {
      ...
      class i3 {
        ...
        er(e) {
          T(i2, `Garbage collection scheduled in ${e}ms`),
      ...
      class i4 {
        ...
        nthSequenceNumber(e, t) {
          if (0 === t) return ea.resolve(eT.ae);
          let n = new i8(t);
          return this.tr
	...
	Determined least recently used ${r} in ` +
      ...
      class i6 {
        constructor(e, t) {
          (this.db = e), (this.garbageCollector = new i4(this, t));
        }
        nr(e) {
          let t = this.sr(e);
          return this.db
        ...
        ar(e, t) {
          ...
          return (
            ...
            tw(e, ek)
              .X((r) =>
                iZ(e, r, t).next((e) => (e && (n = !0), ea.resolve(!e))),
              )
              .next(() => n)
          );
        }
        removeOrphanedDocuments(e, t) {
          let n = this.db.getRemoteDocumentCache().newChangeBuffer(),
            r = [],
            i = 0;
          return this._r(e, (s, a) => {
            if (a <= t) {
              let t = this.ar(e, s).next((t) => {
                if (!t)
                  return (
                    i++,
                    n
                      ...
                      .next(
                        () => (
                          n.removeEntry(s, B.min()),
                          i1(e).delete([0, ex(s.path)])
                        ),
                      )
                  );
              });
        ...
        _r(e, t) {
          let n = i1(e),
            ...
            i = eT.ae;
          return n
            .Z({ index: eY }, ([e, n], { path: s, sequenceNumber: a }) => {
              0 === e
                ? (i !== eT.ae && t(new Q(eS(r)), i), (i = a), (r = s))
                : (i = eT.ae);
            })
            .next(() => {
              i !== eT.ae && t(new Q(eS(r)), i);
            });
        }
        getCacheSize(e) {
      ...
      function i9(e, t) {
        ...
        return i1(e).put(
          ...
          { targetId: 0, path: ex(t.path), sequenceNumber: n }),
        );
      }
      class i7 {
        constructor() {
        ...
        getEntry(e, t) {
          ...
          return void 0 !== n ? ea.resolve(n) : this.getFromCache(e, t);
        }
        getEntries(e, t) {
      ...
      class se {
        ...
        addEntry(e, t, n) {
          return tw(e, eF).put(n);
        }
        removeEntry(e, t, n) {
          return tw(e, eF).delete(
            (function (e, t) {
        ...
        updateMetadata(e, t) {
          return this.getMetadata(e).next(
            (n) => ((n.byteSize += t), this.ur(e, n)),
          );
        }
        getEntry(e, t) {
          let n = no.newInvalidDocument(t);
          return tw(e, eF)
            .Z({ index: eU, range: IDBKeyRange.only(sn(t)) }, (e, r) => {
              n = this.cr(t, r);
            })
            .next(() => n);
        }
        lr(e, t) {
          let n = { size: 0, document: no.newInvalidDocument(t) };
          return tw(e, eF)
            .Z({ index: eU, range: IDBKeyRange.only(sn(t)) }, (e, r) => {
              n = { document: this.cr(t, r), size: iW(r) };
            })
            .next(() => n);
        }
        getEntries(e, t) {
        ...
        Pr(e, t) {
          let n = nZ,
            r = new tE(Q.comparator);
          return this.hr(e, t, (e, t) => {
            let i = this.cr(e, t);
            (n = n.insert(e, i)), (r = r.insert(e, iW(t)));
          }).next(() => ({ documents: n, Tr: r }));
        }
        hr(e, t, n) {
          if (t.isEmpty()) return ea.resolve();
          let r = new tx(si);
          t.forEach((e) => (r = r.add(e)));
          let i = IDBKeyRange.bound(sn(r.first()), sn(r.last())),
            s = r.getIterator(),
            a = s.getNext();
          return tw(e, eF)
            .Z({ index: eU, range: i }, (e, t, r) => {
              let i = Q.fromSegments([
                ...t.prefixPath,
                t.collectionGroup,
                t.documentId,
              ]);
              for (; a && 0 > si(a, i); ) n(a, null), (a = s.getNext());
              a &&
                a.isEqual(i) &&
        ...
        getAllFromCollectionGroup(e, t, n, r) {
          let i = nZ,
            ...
            a = sr(t, et.max());
          return tw(e, eF)
            .Z({ index: eB, range: IDBKeyRange.bound(s, a, !0) }, (e, t, n) => {
              let s = this.cr(
                Q.fromSegments(
        ...
        newChangeBuffer(e) {
          return new st(this, !!e && e.trackRemovals);
        }
        getSize(e) {
        ...
        cr(e, t) {
          if (t) {
            let e = (function (e, t) {
              let n;
              if (t.document)
                n = r6(e.Tt, t.document, !!t.hasCommittedMutations);
              else if (t.noDocument) {
                let e = Q.fromSegments(t.noDocument.path),
                  r = id(t.noDocument.readTime);
                (n = no.newNoDocument(e, r)),
                  t.hasCommittedMutations && n.setHasCommittedMutations();
              } else {
                if (!t.unknownDocument) return x();
                {
                  let e = Q.fromSegments(t.unknownDocument.path),
                    r = id(t.unknownDocument.version);
                  n = no.newUnknownDocument(e, r);
                }
              }
              return (
                t.readTime &&
          ...
          return no.newInvalidDocument(e);
        }
      }
      class st extends i7 {
        constructor(e, t) {
        ...
        applyChanges(e) {
          let t = [],
            n = 0,
            r = new tx((e, t) => P(e.canonicalString(), t.canonicalString()));
          return (
            this.changes.forEach((i, s) => {
              let a = this.Er.get(i);
              if (
                (t.push(this.Ir.removeEntry(e, i, a.readTime)),
                s.isValidDocument())
              ) {
                let o = iu(this.Ir.serializer, s);
                r = r.add(i.path.popLast());
                let l = iW(o);
                (n += l - a.size), t.push(this.Ir.addEntry(e, i, o));
              } else if (((n -= a.size), this.trackRemovals)) {
                let n = iu(this.Ir.serializer, s.convertToNoDocument(B.min()));
            ...
            t.push(this.Ir.updateMetadata(e, n)),
            ea.waitFor(t)
          );
        }
        getFromCache(e, t) {
          return this.Ir.lr(e, t).next(
            (e) => (
              this.Er.set(t, { size: e.size, readTime: e.document.readTime }),
              e.document
            ),
          );
        }
        getAllFromCache(e, t) {
          return this.Ir.Pr(e, t).next(
            ({ documents: e, Tr: t }) => (
              t.forEach((t, n) => {
                this.Er.set(t, { size: n, readTime: e.get(t).readTime });
              }),
              e
            ),
          );
      ...
      function si(e, t) {
        ...
        for (let e = 0; e < n.length - 2 && e < r.length - 2; ++e)
          if ((i = P(n[e], r[e]))) return i;
        return (
          (i = P(n.length, r.length)) ||
          (i = P(n[n.length - 2], r[r.length - 2])) ||
          P(n[n.length - 1], r[r.length - 1])
        );
      }
      class ss {
        constructor(e, t) {
      ...
      class sa {
        ...
        getDocument(e, t) {
          ...
          return this.documentOverlayCache
            ...
            .next(
              (e) => (null !== n && rg(n.mutation, e, tC.empty(), q.now()), e),
            );
        }
        getDocuments(e, t) {
          return this.remoteDocumentCache
            .getEntries(e, t)
            .next((t) =>
              this.getLocalViewOfDocuments(e, t, n8()).next(() => t),
            );
        }
        getLocalViewOfDocuments(e, t, n = n8()) {
          let r = n1();
        ...
        computeViews(e, t, n, r) {
          ...
          return (
            t.forEach((e, t) => {
              let a = n.get(t.key);
              r.has(t.key) && (void 0 === a || a.mutation instanceof rw)
                ? (i = i.insert(t.key, t))
                : void 0 !== a
                  ? (s.set(t.key, a.mutation.getFieldMask()),
                    rg(a.mutation, t, a.mutation.getFieldMask(), q.now()))
                  : s.set(t.key, tC.empty());
            }),
            ...
            .next((e) => {
              for (let i of e)
                i.keys().forEach((e) => {
                  let s = t.get(e);
                  if (null === s) return;
                  let a = n.get(e) || tC.empty();
                  (a = i.applyToLocalView(s, a)), n.set(e, a);
                  let o = (r.get(i.batchId) || n8()).add(e);
            ...
            .next((i) => {
              ...
              return s.next((t) =>
                ea
                  ...
                  .next(() => this.computeViews(e, o, t, n8()))
                  .next((e) => ({ batchId: a, changes: n0(e) })),
              );
            });
        }
          ...
          return this.documentOverlayCache
            ...
            .next((e) => {
              i.forEach((t, n) => {
                let r = n.getKey();
                null === e.get(r) &&
                  (e = e.insert(r, no.newInvalidDocument(r)));
              });
              let n = nX();
              return (
                e.forEach((e, r) => {
                  let s = i.get(e);
                  void 0 !== s && rg(s.mutation, r, tC.empty(), q.now()),
                    nQ(t, r) && (n = n.insert(e, r));
                }),
                n
              );
            });
      ...
      class so {
        ...
        getBundleMetadata(e, t) {
          return ea.resolve(this.dr.get(t));
        }
        saveBundleMetadata(e, t) {
          return (
            this.dr.set(t.id, {
              id: t.id,
              version: t.version,
              createTime: rY(t.createTime),
            }),
            ea.resolve()
          );
        }
        getNamedQuery(e, t) {
          return ea.resolve(this.Ar.get(t));
        }
        saveNamedQuery(e, t) {
          return (
            this.Ar.set(t.name, {
              name: t.name,
              query: iy(t.bundledQuery),
              readTime: rY(t.readTime),
            }),
            ea.resolve()
          );
        }
      ...
      class sl {
        constructor() {
          (this.overlays = new tE(Q.comparator)), (this.Rr = new Map());
        }
        getOverlay(e, t) {
          return ea.resolve(this.overlays.get(t));
        }
        getOverlays(e, t) {
          let n = n1();
          return ea
        ...
        getOverlaysForCollectionGroup(e, t, n, r) {
          ...
          for (; s.hasNext(); ) {
            ...
            if (e.getKey().getCollectionGroup() === t && e.largestBatchId > n) {
              ...
              null === t && ((t = n1()), (i = i.insert(e.largestBatchId, t))),
                t.set(e.getKey(), e);
            }
          }
          let a = n1(),
        ...
        Et(e, t, n) {
          ...
          if (null !== r) {
            let e = this.Rr.get(r.largestBatchId).delete(n.key);
            this.Rr.set(r.largestBatchId, e);
          }
          this.overlays = this.overlays.insert(n.key, new rS(t, n));
          let i = this.Rr.get(t);
          void 0 === i && ((i = n8()), this.Rr.set(t, i)),
            this.Rr.set(t, i.add(n.key));
        }
      }
      class su {
        constructor() {
          this.sessionToken = tk.EMPTY_BYTE_STRING;
        }
        getSessionToken(e) {
          return ea.resolve(this.sessionToken);
        }
        setSessionToken(e, t) {
          return (this.sessionToken = t), ea.resolve();
        }
      }
      class sh {
        constructor() {
          (this.Vr = new tx(sc.mr)), (this.gr = new tx(sc.pr));
        }
        isEmpty() {
      ...
      class sc {
        ...
        static mr(e, t) {
          return Q.comparator(e.key, t.key) || P(e.Cr, t.Cr);
        }
        static pr(e, t) {
          return P(e.Cr, t.Cr) || Q.comparator(e.key, t.key);
        }
      }
      class sd {
        constructor(e, t) {
          (this.indexManager = e),
            ...
            (this.mutationQueue = []),
            (this.Fr = 1),
            (this.Mr = new tx(sc.mr));
        }
        checkEmpty(e) {
          return ea.resolve(0 === this.mutationQueue.length);
        }
        addMutationBatch(e, t, n, r) {
          let i = this.Fr;
          this.Fr++,
          ...
          let s = new rb(i, t, n, r);
          for (let t of (this.mutationQueue.push(s), r))
            (this.Mr = this.Mr.add(new sc(t.key, i))),
        ...
        getHighestUnacknowledgedBatchId() {
          return ea.resolve(0 === this.mutationQueue.length ? -1 : this.Fr - 1);
        }
        getAllMutationBatches(e) {
          return ea.resolve(this.mutationQueue.slice());
        }
        getAllMutationBatchesAffectingDocumentKey(e, t) {
          let n = new sc(t, 0),
            r = new sc(t, Number.POSITIVE_INFINITY),
            i = [];
          return (
        ...
        getAllMutationBatchesAffectingDocumentKeys(e, t) {
          ...
          return (
            t.forEach((e) => {
              let t = new sc(e, 0),
                r = new sc(e, Number.POSITIVE_INFINITY);
              this.Mr.forEachInRange([t, r], (e) => {
                n = n.add(e.Cr);
              });
            }),
            ea.resolve(this.Br(n))
          );
        }
        getAllMutationBatchesAffectingQuery(e, t) {
          let n = t.path,
          ...
          let s = new sc(new Q(i), 0),
            a = new tx(P);
          return (
            this.Mr.forEachWhile((e) => {
              let t = e.key.path;
              return (
                !!n.isPrefixOf(t) && (t.length === r && (a = a.add(e.Cr)), !0)
              );
            }, s),
            ea.resolve(this.Br(a))
          );
        }
        Br(e) {
          let t = [];
        ...
        removeMutationBatch(e, t) {
          0 === this.Lr(t.batchId, "removed") || x(),
            this.mutationQueue.shift();
          let n = this.Mr;
          return ea
            .forEach(t.mutations, (r) => {
              let i = new sc(r.key, t.batchId);
              return (
                (n = n.delete(i)),
        ...
        containsKey(e, t) {
          ...
          return ea.resolve(t.isEqual(r && r.key));
        }
        performConsistencyCheck(e) {
          return this.mutationQueue.length, ea.resolve();
        }
        Lr(e, t) {
          return this.Nr(e);
        }
      ...
      class sf {
        constructor(e) {
          (this.kr = e), (this.docs = new tE(Q.comparator)), (this.size = 0);
        }
        setIndexManager(e) {
          this.indexManager = e;
        }
        ...
        getDocumentsMatchingQuery(e, t, n, r) {
          let i = nZ,
            s = t.path,
            a = new Q(s.child("__id-9223372036854775808__")),
        ...
        qr(e, t) {
          return ea.forEach(this.docs, (e) => t(e));
        }
        newChangeBuffer(e) {
          return new sm(this);
        }
        getSize(e) {
          return ea.resolve(this.size);
        }
      }
      class sm extends i7 {
        constructor(e) {
      ...
      class sg {
        ...
        forEachTarget(e, t) {
          return this.Qr.forEach((e, n) => t(n)), ea.resolve();
        }
        getLastRemoteSnapshotVersion(e) {
          return ea.resolve(this.lastRemoteSnapshotVersion);
        }
        getHighestSequenceNumber(e) {
          return ea.resolve(this.$r);
        }
        allocateTargetId(e) {
          return (
            (this.highestTargetId = this.Ur.next()),
        ...
        zn(e) {
          ...
          t > this.highestTargetId &&
            ((this.Ur = new iX(t)), (this.highestTargetId = t)),
            e.sequenceNumber > this.$r && (this.$r = e.sequenceNumber);
        }
        addTargetData(e, t) {
          return this.zn(t), (this.targetCount += 1), ea.resolve();
        }
        updateTargetData(e, t) {
          return this.zn(t), ea.resolve();
        }
        removeTargetData(e, t) {
          return (
            this.Qr.delete(t.target),
            this.Kr.br(t.targetId),
            (this.targetCount -= 1),
            ea.resolve()
          );
        }
        ...
        getTargetCount(e) {
          return ea.resolve(this.targetCount);
        }
        getTargetData(e, t) {
          let n = this.Qr.get(t) || null;
          return ea.resolve(n);
        }
        addMatchingKeys(e, t, n) {
          return this.Kr.yr(t, n), ea.resolve();
        }
        removeMatchingKeys(e, t, n) {
          this.Kr.Sr(t, n);
        ...
        removeMatchingKeysForTargetId(e, t) {
          return this.Kr.br(t), ea.resolve();
        }
        getMatchingKeysForTargetId(e, t) {
          let n = this.Kr.vr(t);
          return ea.resolve(n);
        ...
        containsKey(e, t) {
          return ea.resolve(this.Kr.containsKey(t));
        }
      }
      class sp {
        constructor(e, t) {
          (this.Wr = {}),
            ...
            (this.remoteDocumentCache = new sf((e) =>
              this.referenceDelegate.Jr(e),
            )),
            (this.serializer = new il(t)),
            (this.Yr = new so(this.serializer));
        }
        start() {
        ...
        getDocumentOverlayCache(e) {
          ...
          return t || ((t = new sl()), (this.overlays[e.toKey()] = t)), t;
        }
        getMutationQueue(e, t) {
          let n = this.Wr[e.toKey()];
          return (
            n ||
              ((n = new sd(t, this.referenceDelegate)),
              (this.Wr[e.toKey()] = n)),
            n
          );
        }
      ...
      class sw {
        constructor(e) {
          (this.persistence = e), (this.ti = new sh()), (this.ni = null);
        }
        static ri(e) {
          return new sw(e);
        }
        ...
        addReference(e, t, n) {
          return (
            this.ti.addReference(n, t),
            this.ii.delete(n.toString()),
            ea.resolve()
          );
        }
        removeReference(e, t, n) {
          return (
            ...
            this.ii.add(n.toString()),
            ea.resolve()
          );
        }
        markPotentiallyOrphaned(e, t) {
          return this.ii.add(t.toString()), ea.resolve();
        }
        removeTarget(e, t) {
        ...
        si(e, t) {
          return ea.or([
            () => ea.resolve(this.ti.containsKey(t)),
      ...
      class sv {
        constructor(e, t) {
          (this.persistence = e),
            ...
            (this.garbageCollector = new i4(this, t));
        }
        static ri(e, t) {
          return new sv(e, t);
        }
        ...
        rr(e, t) {
          return ea.forEach(this.oi, (n, r) =>
            this.ar(e, n, r).next((e) => (e ? ea.resolve() : t(r))),
          );
        }
        removeTargets(e, t, n) {
        ...
        markPotentiallyOrphaned(e, t) {
          return this.oi.set(t, e.currentSequenceNumber), ea.resolve();
        }
        removeTarget(e, t) {
          let n = t.withSequenceNumber(e.currentSequenceNumber);
        ...
        addReference(e, t, n) {
          return this.oi.set(n, e.currentSequenceNumber), ea.resolve();
        }
        removeReference(e, t, n) {
          return this.oi.set(n, e.currentSequenceNumber), ea.resolve();
        }
            ...
            e.isFoundDocument() &&
              (t += (function e(t) {
                switch (tZ(t)) {
                  ...
                  case 6:
                    return tL(t.bytesValue).approximateByteSize();
                  case 7:
        ...
        ar(e, t, n) {
          return ea.or([
            ...
            () => {
              let e = this.oi.get(t);
              return ea.resolve(void 0 !== e && e > n);
            },
          ]);
        }
        getCacheSize(e) {
      ...
      class sI {
        ...
        B(e, t, n, r) {
          let i = new el("createOrUpgrade", t);
          n < 1 &&
            r >= 1 &&
            (!(function (e) {
              e.createObjectStore(eC);
            })(e),
            e.createObjectStore(ek, { keyPath: "userId" }),
            e
              .createObjectStore(eA, { keyPath: eV, autoIncrement: !0 })
              .createIndex(eR, eL, { unique: !0 }),
            e.createObjectStore(eO),
            sT(e),
            (function (e) {
              e.createObjectStore(eN);
            })(e));
          let s = ea.resolve();
          return (
            n < 3 &&
              r >= 3 &&
              (0 !== n &&
                (e.deleteObjectStore(eH),
                e.deleteObjectStore(eG),
                e.deleteObjectStore(eX),
                sT(e)),
              (s = s.next(() =>
                (function (e) {
                  let t = e.store(eX),
            ...
            n < 4 &&
              ...
              (0 !== n &&
                (s = s.next(() =>
                  i
                    ...
                    .G()
                    .next((t) => {
                      e.deleteObjectStore(eA),
                        e
                          .createObjectStore(eA, {
                            keyPath: eV,
                            autoIncrement: !0,
                          })
                          .createIndex(eR, eL, { unique: !0 });
              ...
              (s = s.next(() => {
                !(function (e) {
                  e.createObjectStore(e2, { keyPath: "clientId" });
                })(e);
              }))),
            n < 5 && r >= 5 && (s = s.next(() => this._i(i))),
            n < 6 &&
              r >= 6 &&
              (s = s.next(
                () => (
            ...
            n < 7 && r >= 7 && (s = s.next(() => this.ui(i))),
            n < 8 && r >= 8 && (s = s.next(() => this.ci(e, i))),
            n < 9 &&
              r >= 9 &&
              (s = s.next(() => {
            ...
            n < 10 && r >= 10 && (s = s.next(() => this.li(i))),
            n < 11 &&
              r >= 11 &&
              (s = s.next(() => {
                (function (e) {
                  e.createObjectStore(e5, { keyPath: "bundleId" });
                })(e),
                  (function (e) {
                    e.createObjectStore(e8, { keyPath: "name" });
                  })(e);
              })),
            n < 12 &&
              r >= 12 &&
              (s = s.next(() => {
                !(function (e) {
                  let t = e.createObjectStore(ts, { keyPath: ta });
                  t.createIndex(to, tl, { unique: !1 }),
                    t.createIndex(tu, th, { unique: !1 });
                })(e);
              })),
            n < 13 &&
              r >= 13 &&
              (s = s
                .next(() =>
                  (function (e) {
                    let t = e.createObjectStore(eF, { keyPath: eP });
                    t.createIndex(eU, eq), t.createIndex(eB, eK);
                  })(e),
                )
                .next(() => this.hi(e, i))
                .next(() => e.deleteObjectStore(eN))),
            n < 14 && r >= 14 && (s = s.next(() => this.Pi(e, i))),
            n < 15 &&
              r >= 15 &&
              (s = s.next(() => {
                e
                  .createObjectStore(e3, {
                    keyPath: "indexId",
                    autoIncrement: !0,
                  })
                  .createIndex(e4, "collectionGroup", { unique: !1 }),
                  e
                    .createObjectStore(e6, { keyPath: e9 })
                    .createIndex(e7, te, { unique: !1 }),
                  e
                    .createObjectStore(tt, { keyPath: tn })
                    .createIndex(tr, ti, { unique: !1 });
              })),
            n < 16 &&
              r >= 16 &&
              (s = s
                .next(() => {
                  t.objectStore(e6).clear();
                })
                .next(() => {
            ...
            n < 17 &&
              ...
              (s = s.next(() => {
                !(function (e) {
                  e.createObjectStore(tc, { keyPath: "name" });
                })(e);
              })),
            s
          );
        ...
        _i(e) {
          ...
          return t.G().next((t) =>
            ea.forEach(t, (t) => {
              ...
              return n.G(eR, r).next((n) =>
                ea.forEach(n, (n) => {
                  n.userId === t.userId || x();
                  let r = im(this.serializer, n);
                  return iH(e, t.userId, r).next(() => {});
                }),
              );
            }),
          );
        ...
        ci(e, t) {
          e.createObjectStore(e0, { keyPath: e1 });
          let n = t.store(e0),
            r = new iB(),
            i = (e) => {
              if (r.add(e)) {
                let t = e.lastSegment(),
                  r = e.popLast();
                return n.put({ collectionId: t, parent: ex(r) });
              }
            };
          return t
            .store(eN)
            .Z({ Y: !0 }, (e, t) => i(new $(e).popLast()))
            .next(() =>
              t.store(eO).Z({ Y: !0 }, ([e, t, n], r) => i(eS(t).popLast())),
            );
        }
        li(e) {
          let t = e.store(eG);
          ...
          return n
            .Z((e, n) => {
              let i = t.store(eF),
                s = (
                  n.document
                    ? new Q($.fromString(n.document.name).popFirst(5))
                    : n.noDocument
                      ? Q.fromSegments(n.noDocument.path)
                      : n.unknownDocument
                        ? Q.fromSegments(n.unknownDocument.path)
                        : x()
                ).path.toArray(),
                a = {
        ...
        Pi(e, t) {
          let n = t.store(eA),
            r = new se(this.serializer),
            i = new sp(sw.ri, this.serializer.Tt);
          return n.G().next((e) => {
            let n = new Map();
            return (
              e.forEach((e) => {
                var t;
                let r =
                  null !== (t = n.get(e.userId)) && void 0 !== t ? t : n8();
                im(this.serializer, e)
                  .keys()
                  .forEach((e) => (r = r.add(e))),
                  n.set(e.userId, r);
              }),
              ea.forEach(n, (e, n) => {
                let s = new y(n),
                  a = iE.It(this.serializer, s),
                  o = i.getIndexManager(s);
                return new sa(
                  r,
                  iY.It(s, this.serializer, o, i.referenceDelegate),
                  a,
                  o,
                )
      ...
      function sT(e) {
        e
          .createObjectStore(eH, { keyPath: eW })
          .createIndex(eY, eZ, { unique: !0 }),
          e
            .createObjectStore(eG, { keyPath: "targetId" })
            .createIndex(ej, eQ, { unique: !0 }),
          e.createObjectStore(eX);
      }
      let sE = "IndexedDbPersistence",
        s_ =
      ...
      class sb {
        constructor(e, t, n, r, i, s, a, o, l, u, h = 17) {
          ...
          (this.referenceDelegate = new i6(this, r)),
            (this.gi = t + "main"),
            (this.serializer = new il(o)),
            (this.pi = new eu(this.gi, this.di, new sI(this.serializer))),
            (this.jr = new i_()),
            (this.Hr = new i0(this.referenceDelegate, this.serializer)),
            (this.remoteDocumentCache = new se(this.serializer)),
            (this.Yr = new iT()),
            this.window && this.window.localStorage
              ? (this.yi = this.window.localStorage)
              : ((this.yi = null),
                !1 === u &&
                  E(
                    sE,
          ...
          return this.wi()
            .then(() => {
              if (!this.isPrimary && !this.allowTabSynchronization)
                throw new N(S.FAILED_PRECONDITION, s_);
              return (
                this.Si(),
                this.bi(),
                this.Di(),
                this.runTransaction(
                  ...
                  "readonly",
                  (e) => this.Hr.getHighestSequenceNumber(e),
                )
              );
            })
            .then((e) => {
              this.Gr = new eT(e, this.Ii);
            })
            .then(() => {
              this.zr = !0;
            })
        ...
        wi() {
          return this.runTransaction(
                ...
                .next(() => {
                  if (this.isPrimary)
                    return this.Fi(e).next((e) => {
                      e ||
                        ((this.isPrimary = !1),
                        this.Ti.enqueueRetryable(() => this.fi(!1)));
                    });
                })
                .next(() => this.Mi(e))
                .next((t) =>
            ...
            .catch((e) => {
              if (ef(e))
                return (
                  T(sE, "Failed to extend owner lease: ", e), this.isPrimary
                );
            ...
            .then((e) => {
              this.isPrimary !== e &&
                this.Ti.enqueueRetryable(() => this.fi(e)),
                (this.isPrimary = e);
            });
        }
        Fi(e) {
          return tw(e, eC)
            .get(eD)
            .next((e) => ea.resolve(this.Ni(e)));
        }
        Bi(e) {
          return tw(e, e2).delete(this.clientId);
        }
        async Li() {
          if (this.isPrimary && !this.ki(this.mi, 18e5)) {
            this.mi = Date.now();
            ...
            if (this.yi)
              for (let t of e) this.yi.removeItem(this.Qi(t.clientId));
          }
        }
        Di() {
          this.Vi = this.Ti.enqueueAfterDelay(
          ...
          return this.Ei
            ...
            : tw(e, eC)
                ...
                .next((t) => {
                  if (
                    null !== t &&
                    this.ki(t.leaseTimestampMs, 5e3) &&
                    !this.$i(t.ownerId)
                  ) {
        ...
        async shutdown() {
          (this.zr = !1),
            this.Ki(),
            this.Vi && (this.Vi.cancel(), (this.Vi = null)),
            this.Ui(),
            this.Wi(),
            await this.pi.runTransaction(
              "shutdown",
              "readwrite",
              [eC, e2],
              (e) => {
                let t = new ty(e, eT.ae);
        ...
        qi(e, t) {
          return e.filter(
            (e) => this.ki(e.updateTimeMs, t) && !this.$i(e.clientId),
          );
        }
        zi() {
          return this.runTransaction("getActiveClients", "readonly", (e) =>
            tw(e, e2)
              .G()
              .next((e) => this.qi(e, 18e5).map((e) => e.clientId)),
          );
        }
        get started() {
          return this.zr;
        ...
        getMutationQueue(e, t) {
          return iY.It(e, this.serializer, t, this.referenceDelegate);
        }
        getTargetCache() {
          return this.Hr;
        }
        ...
        getIndexManager(e) {
          return new i$(e, this.serializer.Tt.databaseId);
        }
        getDocumentOverlayCache(e) {
          return iE.It(this.serializer, e);
        }
        getBundleCache() {
          return this.Yr;
        }
        runTransaction(e, t, n) {
          ...
          return this.pi
            .runTransaction(
              ...
              s,
              (r) => (
                (i = new ty(r, this.Gr ? this.Gr.next() : eT.ae)),
                "readwrite-primary" === t
                  ? this.Fi(i)
                      .next((e) => !!e || this.Mi(i))
                      .next((t) => {
                        if (!t)
                          throw (
                            ...
                            (this.isPrimary = !1),
                            this.Ti.enqueueRetryable(() => this.fi(!1)),
                            new N(S.FAILED_PRECONDITION, er))
                          );
                        return n(i);
                      })
                      .next((e) => this.Oi(i).next(() => e))
                  : this.ji(i).next(() => n(i))
              ),
            )
        ...
        ji(e) {
          return tw(e, eC)
            ...
            .next((e) => {
              if (
                null !== e &&
                this.ki(e.leaseTimestampMs, 5e3) &&
                !this.$i(e.ownerId) &&
                !this.Ni(e) &&
                !(
                  this.Ei ||
        ...
        xi(e) {
          ...
          return t
            ...
            .next((e) =>
              this.Ni(e)
                ? (T(sE, "Releasing primary lease."), t.delete(eD))
                : ea.resolve(),
            );
        }
        ki(e, t) {
        ...
        Si() {
          null !== this.document &&
            ...
            this.document.addEventListener("visibilitychange", this.Ri),
            (this.inForeground = "visible" === this.document.visibilityState));
        }
        Ui() {
          this.Ri &&
            (this.document.removeEventListener("visibilitychange", this.Ri),
            (this.Ri = null));
        }
        bi() {
          var e;
        ...
        $i(e) {
          ...
          try {
            ...
            return E(sE, "Failed to get zombied client id.", e), !1;
          }
        }
        Ki() {
          if (this.yi)
      ...
      class sC {
        constructor() {
          (this.Zi = !1),
            (this.Xi = !1),
            (this.es = 100),
            (this.ts = (0, h.nr)() ? 8 : eh((0, h.ZQ)()) > 0 ? 6 : 4);
        }
        initialize(e, t) {
            ...
            : (I() <= u.$b.DEBUG &&
              ...
              n.documentReadCount > this.ts * r
                ? (I() <= u.$b.DEBUG &&
                  ...
                  this.indexManager.createTargetIndexes(e, nB(t)))
                : ea.resolve());
        }
        rs(e, t) {
          if (nP(t)) return ea.resolve(null);
          let n = nB(t);
        ...
        _s(e, t, n) {
          return (
            ...
            this.ns.getDocumentsMatchingQuery(e, t, et.min(), n)
          );
        }
        hs(e, t, n, r) {
        ...
        return await e.persistence.runTransaction(
          ...
          (n) => {
            ...
            return e.mutationQueue
              ...
              .next(
                (i) => (
                  (r = i), e.As(t), e.mutationQueue.getAllMutationBatches(n)
                ),
              )
              .next((t) => {
                let i = [],
      ...
      function sL(e, t) {
        return e.persistence
          .runTransaction("Allocate target", "readwrite", (n) => {
            let r;
            return e.Hr.getTargetData(n, t).next((i) =>
              i
                ? ((r = i), ea.resolve(r))
                : e.Hr.allocateTargetId(n).next(
                    (i) => (
                      (r = new io(
                        t,
                        i,
                      ...
                      e.Hr.addTargetData(n, r).next(() => r)
                    ),
                  ),
            );
          })
          .then((n) => {
            let r = e.Ts.get(n.targetId);
            return (
              (null === r ||
                n.snapshotVersion.compareTo(r.snapshotVersion) > 0) &&
                ((e.Ts = e.Ts.insert(n.targetId, n)), e.Is.set(t, n.targetId)),
              n
            );
          });
      }
      async function sM(e, t, n) {
        ...
        try {
          ...
          if (!ef(e)) throw e;
          T(sD, `Failed to update sequence numbers for target ${t}: ${e}`);
        }
        (e.Ts = e.Ts.remove(t)), e.Is.delete(r.target);
      }
      function sO(e, t, n) {
        let r = B.min(),
          i = n8();
        return e.persistence.runTransaction("Execute query", "readwrite", (s) =>
          (function (e, t, n) {
            let r = e.Is.get(n);
            return void 0 !== r
              ? ea.resolve(e.Ts.get(r))
              : e.Hr.getTargetData(t, n);
          })(e, s, nB(t))
            .next((t) => {
              if (t)
                return (
            ...
            .next((n) => (sU(e, nH(t), n), { documents: n, gs: i })),
        );
      }
      function sF(e, t) {
        let n = e.Hr,
        ...
        return r
          ...
          : e.persistence.runTransaction("Get target data", "readonly", (e) =>
              n.lt(e, t).next((e) => (e ? e.target : null)),
            );
      }
      function sP(e, t) {
        let n = e.Es.get(t) || B.min();
        return e.persistence
          .runTransaction("Get new document changes", "readonly", (r) =>
            e.ds.getAllFromCollectionGroup(
              r,
              t,
              X(n, -1),
              Number.MAX_SAFE_INTEGER,
      ...
      function sU(e, t, n) {
        let r = e.Es.get(t) || B.min();
        n.forEach((e, t) => {
          t.readTime.compareTo(r) > 0 && (r = t.readTime);
        }),
          e.Es.set(t, r);
      }
      let sq = "firestore_clients";
      function sB(e, t) {
        return `${sq}_${e}_${t}`;
      }
      let sK = "firestore_mutations";
      function sz(e, t, n) {
        let r = `${sK}_${e}_${n}`;
        return t.isAuthenticated() && (r += `_${t.uid}`), r;
      }
      let s$ = "firestore_targets";
      function sG(e, t) {
        return `${s$}_${e}_${t}`;
      }
      let sj = "SharedClientState";
      class sQ {
        constructor(e, t, n, r) {
          (this.user = e),
            (this.batchId = t),
        ...
        static Ss(e, t, n) {
          ...
          return (
            s &&
              ...
              (i = new N(r.error.code, r.error.message)),
            s
              ? new sQ(e, t, r.state, i)
              : (E(sj, `Failed to parse mutation state for ID '${t}': ${n}`),
                null)
          );
        }
        bs() {
        ...
        static Ss(e, t) {
          ...
          return (
            i &&
              ...
              (r = new N(n.error.code, n.error.message)),
            i
              ? new sH(e, n.state, r)
              : (E(sj, `Failed to parse target state for ID '${e}': ${t}`),
                null)
          );
        }
        bs() {
      ...
      class sW {
        ...
        static Ss(e, t) {
          ...
          for (let e = 0; r && e < n.activeTargetIds.length; ++e)
            (r = eb(n.activeTargetIds[e])), (i = i.add(n.activeTargetIds[e]));
          return r
            ? new sW(e, i)
            : (E(sj, `Failed to parse client data for instance '${e}': ${t}`),
              null);
        }
      }
      class sY {
        ...
        static Ss(e) {
          ...
          return "object" == typeof t &&
            ...
            ? new sY(t.clientId, t.onlineState)
            : (E(sj, `Failed to parse online state: ${e}`), null);
        }
      }
      class sZ {
        constructor() {
          this.activeTargetIds = n3;
        }
        Ds(e) {
      ...
      class sJ {
        constructor(e, t, n, r, i) {
          ...
          (this.storage = this.window.localStorage),
            (this.currentUser = i),
            (this.Ns = sB(this.persistenceKey, this.Cs)),
            (this.Bs =
              ((s = this.persistenceKey), `firestore_sequence_number_${s}`)),
            (this.xs = this.xs.insert(this.Cs, new sZ())),
            (this.Ls = RegExp(`^${sq}_${l}_([^_]*)$`)),
            (this.ks = RegExp(`^${sK}_${l}_(\\d+)(?:_(.*))?$`)),
            (this.qs = RegExp(`^${s$}_${l}_(\\d+)$`)),
            (this.Qs =
        ...
        async start() {
          for (let e of await this.syncEngine.zi()) {
            if (e === this.Cs) continue;
            let t = this.getItem(sB(this.persistenceKey, e));
            if (t) {
              let n = sW.Ss(e, t);
          ...
          this.Ks();
          let e = this.storage.getItem(this.Qs);
          if (e) {
            let t = this.Us(e);
            t && this.Ws(t);
          }
          for (let e of this.Os) this.Ms(e);
          (this.Os = []),
        ...
        addLocalQueryTarget(e, t = !0) {
          ...
          if (this.isActiveQueryTarget(e)) {
            let t = this.storage.getItem(sG(this.persistenceKey, e));
            if (t) {
              let r = sH.Ss(e, t);
              r && (n = r.state);
            }
        ...
        clearQueryState(e) {
          this.removeItem(sG(this.persistenceKey, e));
        }
        ...
        shutdown() {
          this.started &&
            ...
            this.removeItem(this.Ns),
            (this.started = !1));
        }
        getItem(e) {
          let t = this.storage.getItem(e);
          return T(sj, "READ", e, t), t;
        }
        setItem(e, t) {
          T(sj, "SET", e, t), this.storage.setItem(e, t);
        }
        removeItem(e) {
          T(sj, "REMOVE", e), this.storage.removeItem(e);
        }
        Ms(e) {
          if (e.storageArea === this.storage) {
            if ((T(sj, "EVENT", e.key, e.newValue), e.key === this.Ns))
              return void E(
              ...
              if (this.started) {
                if (null !== e.key) {
                  if (this.Ls.test(e.key)) {
                    if (null == e.newValue) {
                      let t = this.Xs(e.key);
                      return this.eo(t, null);
                    }
                    {
                      let t = this.no(e.key, e.newValue);
                      if (t) return this.eo(t.clientId, t);
                    }
                  } else if (this.ks.test(e.key)) {
                    if (null !== e.newValue) {
                      let t = this.ro(e.key, e.newValue);
                      if (t) return this.io(t);
                    }
                  } else if (this.qs.test(e.key)) {
                    if (null !== e.newValue) {
                      let t = this.so(e.key, e.newValue);
                      if (t) return this.oo(t);
                    }
                  } else if (e.key === this.Qs) {
                    if (null !== e.newValue) {
                      let t = this.Us(e.newValue);
                      if (t) return this.Ws(t);
                    }
                  } else if (e.key === this.Bs) {
                    let t = (function (e) {
                      let t = eT.ae;
                      if (null != e)
                        try {
                          let n = JSON.parse(e);
                          "number" == typeof n || x(), (t = n);
                        } catch (e) {
                          E(
                            sj,
                    ...
                    t !== eT.ae && this.sequenceNumberHandler(t);
                  } else if (e.key === this.$s) {
                    let t = this._o(e.newValue);
                    await Promise.all(t.map((e) => this.syncEngine.ao(e)));
                  }
                }
              } else this.Os.push(e);
            });
        ...
        zs(e, t, n) {
          let r = new sQ(this.currentUser, e, t, n),
            i = sz(this.persistenceKey, this.currentUser, e);
          this.setItem(i, r.bs());
        }
        js(e) {
          let t = sz(this.persistenceKey, this.currentUser, e);
          this.removeItem(t);
        }
        Ys(e) {
          let t = { clientId: this.Cs, onlineState: e };
          this.storage.setItem(this.Qs, JSON.stringify(t));
        }
        Js(e, t, n) {
          let r = sG(this.persistenceKey, e),
            i = new sH(e, t, n);
          this.setItem(r, i.bs());
        }
        Zs(e) {
        ...
        ro(e, t) {
          let n = this.ks.exec(e),
            r = Number(n[1]),
            i = void 0 !== n[2] ? n[2] : null;
          return sQ.Ss(new y(i), r, t);
        }
        so(e, t) {
          let n = Number(this.qs.exec(e)[1]);
          return sH.Ss(n, t);
        }
        Us(e) {
          return sY.Ss(e);
        ...
        async io(e) {
          ...
          T(sj, `Ignoring mutation for non-active user ${e.user.uid}`);
        }
        oo(e) {
      ...
      class sX {
        ...
        start() {
          return (this.ho = new sZ()), Promise.resolve();
        }
        handleUserChange(e, t, n) {}
        setOnlineState(e) {}
        shutdown() {}
      ...
      class s2 {
        ...
        Eo() {
          for (let e of (T(s1, "Network connectivity changed: AVAILABLE"),
          this.Vo))
            e(0);
        }
        Ro() {
          for (let e of (T(s1, "Network connectivity changed: UNAVAILABLE"),
          this.Vo))
            e(1);
        }
        static D() {
      ...
      function s8() {
        return (
          null === s5
            ? (s5 = 0x10000000 + Math.round(0x80000000 * Math.random()))
            : s5++,
          "0x" + s5.toString(16)
        );
      }
      let s3 = "RestConnection",
        s4 = {
      ...
      class s6 {
        ...
        So(e, t, n, r, i) {
          ...
          return (
            this.Do(o, r, i),
            this.vo(e, a, o, n).then(
              (t) => (T(s3, `Received RPC '${e}' ${s}: `, t), t),
              (t) => {
                throw (
                  (_(
                    s3,
      ...
      class ae extends s6 {
                ...
                try {
                  switch (o.getLastErrorCode()) {
                    case d.O4.NO_ERROR:
                      ...
                      break;
                    case d.O4.TIMEOUT:
                      T(s7, `RPC '${e}' ${i} timed out`),
                        a(new N(S.DEADLINE_EXCEEDED, "Request time out"));
                      break;
                    case d.O4.HTTP_ERROR:
                      ...
                      } else a(new N(S.UNAVAILABLE, "Connection failed."));
                      break;
                    default:
                      x();
                  }
                } finally {
                  T(s7, `RPC '${e}' ${i} completed.`);
                }
              });
            let l = JSON.stringify(r);
            T(s7, `RPC '${e}' ${i} sending request:`, r),
        ...
        Wo(e, t, n) {
          ...
          let h = s.join("");
          T(s7, `Creating RPC '${e}' stream ${i}: ${h}`, l);
            ...
            g = new s9({
              Fo: (t) => {
                m
                  ...
                  : (f ||
                      (T(s7, `Opening RPC '${e}' stream ${i} transport.`),
                      c.open(),
                      (f = !0)),
                    T(s7, `RPC '${e}' stream ${i} sending:`, t),
                    c.send(t));
              },
              Mo: () => c.close(),
            }),
          ...
          return (
            p(c, d.iO.EventType.OPEN, () => {
              m || (T(s7, `RPC '${e}' stream ${i} transport opened.`), g.Qo());
            }),
            p(c, d.iO.EventType.CLOSE, () => {
              m ||
                ((m = !0),
                T(s7, `RPC '${e}' stream ${i} transport closed`),
                g.Ko());
            }),
            p(c, d.iO.EventType.ERROR, (t) => {
              m ||
                ((m = !0),
                _(s7, `RPC '${e}' stream ${i} transport errored:`, t),
                g.Ko(
                  new N(S.UNAVAILABLE, "The operation could not be completed"),
                ));
            }),
            p(c, d.iO.EventType.MESSAGE, (t) => {
              ...
              if (!m) {
                ...
                if (a) {
                  T(s7, `RPC '${e}' stream ${i} received error:`, a);
                  let t = a.status,
                    n = (function (e) {
                      let t = r[e];
                      if (void 0 !== t) return rC(t);
                    })(t),
                    s = a.message;
                  void 0 === n &&
                    ((n = S.INTERNAL),
                    ...
                    g.Ko(new N(n, s)),
                    c.close();
                } else T(s7, `RPC '${e}' stream ${i} received:`, s), g.Uo(s);
              }
            }),
            p(o, d.Jh.STAT_EVENT, (t) => {
              t.stat === d.ro.PROXY
                ? T(s7, `RPC '${e}' stream ${i} detected buffering proxy`)
                : t.stat === d.ro.NOPROXY &&
                  T(s7, `RPC '${e}' stream ${i} detected no buffering proxy`);
            }),
            setTimeout(() => {
              g.$o();
            }, 0),
      ...
      class ao extends aa {
              ...
              if ("targetChange" in t) {
                ...
                let s =
                  ...
                  o =
                    ...
                    e.useProto3Json
                      ? (void 0 === i || "string" == typeof i || x(),
                        tk.fromBase64String(i || ""))
                      : (void 0 === i ||
                          i instanceof m ||
                          i instanceof Uint8Array ||
                          x(),
                        tk.fromUint8Array(i || new Uint8Array()))),
                ...
                n = new rP(
                  ...
                  (l &&
                    new N(
                      void 0 === l.code ? S.UNKNOWN : rC(l.code),
                      l.message || "",
                    )) ||
                    null,
                );
                ...
                let i = r1(e, r.document.name),
                  s = rY(r.document.updateTime),
                  a = r.document.createTime
                    ? rY(r.document.createTime)
                    : B.min(),
                  o = new na({ mapValue: { fields: r.document.fields } }),
                  l = no.newFoundDocument(i, s, a, o);
                n = new rO(
                  r.targetIds || [],
                  r.removedTargetIds || [],
                  l.key,
                ...
                r.document;
                let i = r1(e, r.document),
                  s = r.readTime ? rY(r.readTime) : B.min(),
                  a = no.newNoDocument(i, s);
                n = new rO([], r.removedTargetIds || [], a.key, a);
              } else if ("documentRemove" in t) {
                t.documentRemove;
                let r = t.documentRemove;
                r.document;
                let i = r1(e, r.document);
                n = new rO([], r.removedTargetIds || [], i, null);
              } else {
                if (!("filter" in t)) return x();
                {
                  t.filter;
                  let e = t.filter;
                  e.targetId;
          ...
          (t.database = r8(this.serializer)),
            (t.addTarget = (function (e, t) {
              ...
              if (
                (((n = nV(r)
                  ? { documents: ie(e, r) }
                  : { query: it(e, r).ht }).targetId = t.targetId),
                t.resumeToken.approximateByteSize() > 0)
              ) {
                n.resumeToken = rW(e, t.resumeToken);
                let r = rQ(e, t.expectedCount);
                null !== r && (n.expectedCount = r);
              } else if (t.snapshotVersion.compareTo(B.min()) > 0) {
                n.readTime = rH(e, t.snapshotVersion.toTimestamp());
                let r = rQ(e, t.expectedCount);
                null !== r && (n.expectedCount = r);
              }
              return n;
        ...
        w_(e) {
          let t = {};
          (t.database = r8(this.serializer)), (t.removeTarget = e), this.I_(t);
        }
      }
      class al extends aa {
        constructor(e, t, n, r, i, s) {
        ...
        g_(e) {
          return (
            ...
            e.writeResults && 0 !== e.writeResults.length && x(),
            this.listener.D_()
          );
        }
        onNext(e) {
              ...
              t && t.length > 0
                ? (void 0 !== n || x(),
                  t.map((e) => {
                    let t;
                    return (
                      (t = e.updateTime ? rY(e.updateTime) : rY(n)).isEqual(
                        B.min(),
                      ) && (t = rY(n)),
                      new rh(t, e.transformResults || [])
                    );
                  }))
                : []),
            i = rY(e.commitTime);
          return this.listener.v_(i, r);
        }
        C_() {
          let e = {};
          (e.database = r8(this.serializer)), this.I_(e);
        }
        b_(e) {
          let t = {
            streamToken: this.lastStreamToken,
            writes: e.map((e) => r9(this.serializer, e)),
          };
          this.I_(t);
        }
      }
        ...
        So(e, t, n, r) {
          return (
            ...
            Promise.all([
              ...
              .then(([i, s]) => this.connection.So(e, rJ(t, n), r, i, s))
              .catch((e) => {
        ...
        Co(e, t, n, r, i) {
          return (
            ...
            Promise.all([
              ...
              .then(([s, a]) => this.connection.Co(e, rJ(t, n), r, s, a, i))
              .catch((e) => {
                throw "FirebaseError" === e.name
                  ? (e.code === S.UNAUTHENTICATED &&
                      (this.authCredentials.invalidateToken(),
...
This typically indicates that your device does not have a healthy Internet connection at the moment. The client will operate in offline mode until it is able to successfully connect to the backend.`;
          this.N_ ? (E(t), (this.N_ = !1)) : T("OnlineStateTracker", t);
        }
        Q_() {
          ...
          (this.localStore = e),
            ...
            this.z_.To((e) => {
              n.enqueueAndForget(async () => {
                aE(this) &&
                  (T(ad, "Restarting streams for network reachability change."),
      ...
      async function am(e) {
        if (aE(e)) for (let t of e.G_) await t(!0);
      }
      async function ag(e) {
      ...
      function ap(e, t) {
        e.U_.has(t.targetId) ||
          (e.U_.set(t.targetId, t), aT(e) ? aI(e) : aP(e).c_() && aw(e, t));
      }
      function ay(e, t) {
        let n = aP(e);
        e.U_.delete(t),
          n.c_() && av(e, t),
          0 === e.U_.size && (n.c_() ? n.P_() : aE(e) && e.j_.set("Unknown"));
      }
      function aw(e, t) {
        if (
          (e.H_.Ne(t.targetId),
          t.resumeToken.approximateByteSize() > 0 ||
            t.snapshotVersion.compareTo(B.min()) > 0)
        ) {
      ...
      function aT(e) {
        return aE(e) && !aP(e).u_() && e.U_.size > 0;
      }
      function aE(e) {
        return 0 === e.W_.size;
      }
      ...
      async function ax(e, t) {
        (e.H_ = void 0), aT(e) ? (e.j_.q_(t), aI(e)) : e.j_.set("Unknown");
      }
      async function aS(e, t, n) {
        if ((e.j_.set("Online"), t instanceof rP && 2 === t.state && t.cause))
          try {
            ...
            T(ad, "Failed to remove targets %s: %s ", t.targetIds.join(","), n),
              await aN(e, n);
          }
        else if (
          (t instanceof rO
          ...
          try {
                ...
                return (
                  ...
                  n.targetMismatches.forEach((t, n) => {
                    ...
                    e.U_.set(
                      t,
                      r.withResumeToken(
                        tk.EMPTY_BYTE_STRING,
                        r.snapshotVersion,
                      ),
                    ),
                      av(e, t);
                    let i = new io(r.target, t, n, r.sequenceNumber);
                    aw(e, i);
                  }),
            ...
            T(ad, "Failed to raise snapshot:", t), await aN(e, t);
          }
      }
      async function aN(e, t, n) {
        ...
        e.W_.add(1),
          ...
          e.asyncQueue.enqueueRetryable(async () => {
            T(ad, "Retrying IndexedDB access"),
              await n(),
              e.W_.delete(1),
              await am(e);
          });
      ...
      function aC(e, t) {
        return t().catch((n) => aN(e, n, t));
      }
      async function aD(e) {
        let t = aU(e),
          n = e.K_.length > 0 ? e.K_[e.K_.length - 1].batchId : -1;
        for (; aE(e) && e.K_.length < 10; )
          try {
      ...
      function ak(e) {
        return aE(e) && !aU(e).u_() && e.K_.length > 0;
      }
      function aA(e) {
        aU(e).start();
      }
      ...
      async function aR(e) {
        let t = aU(e);
        for (let n of e.K_) t.b_(n.mutations);
      }
      async function aL(e, t, n) {
        let r = e.K_.shift(),
          i = rx.from(r, t, n);
        await aC(e, () => e.remoteSyncer.applySuccessfulWrite(i)), await aD(e);
      }
      ...
      async function aO(e, t) {
        e.asyncQueue.verifyOperationInProgress(),
          T(ad, "RemoteStore received new credentials");
        let n = aE(e);
        e.W_.add(3),
          await ag(e),
          n && e.j_.set("Unknown"),
      ...
      async function aF(e, t) {
        t
          ? (e.W_.delete(2), await am(e))
          : t || (e.W_.add(2), await ag(e), e.j_.set("Unknown"));
      }
      function aP(e) {
        var t, n, r;
        return (
          e.J_ ||
            ...
            e.G_.push(async (t) => {
              t
                ? (e.J_.h_(), aT(e) ? aI(e) : e.j_.set("Unknown"))
              ...
              t
                ...
                : (await e.Y_.stop(),
                  e.K_.length > 0 &&
                    (T(
                      ad,
                      `Stopping write stream with ${e.K_.length} pending writes`,
                    ),
                    (e.K_ = [])));
            })),
          e.Y_
      ...
      class aq {
        ...
        static createAndSchedule(e, t, n, r, i) {
          let s = new aq(e, t, Date.now() + n, r, i);
          return s.start(n), s;
        }
        start(e) {
        ...
        cancel(e) {
          null !== this.timerHandle &&
            ...
            this.deferred.reject(
              new N(S.CANCELLED, "Operation cancelled" + (e ? ": " + e : "")),
            ));
        }
        handleDelayElapsed() {
      ...
      function aB(e, t) {
        if ((E("AsyncQueue", `${t}: ${e}`), ef(e)))
          return new N(S.UNAVAILABLE, `${t}: ${e}`);
        throw e;
      }
      class aK {
        static emptySet(e) {
          return new aK(e.comparator);
        }
        constructor(e) {
          (this.comparator = e
        ...
        isEqual(e) {
          if (!(e instanceof aK) || this.size !== e.size) return !1;
      ...
      class a$ {
        ...
        static fromInitialDocuments(e, t, n, r, i) {
          ...
          return (
            ...
            new a$(e, t, aK.emptySet(t), s, n, r, !0, !1, i)
          );
        }
        get hasPendingWrites() {
      ...
      class aj {
        ...
        terminate() {
          !(function (e, t) {
            ...
            (e.queries = aQ()),
              n.forEach((e, n) => {
                for (let e of n.ta) e.onError(t);
              });
          })(this, new N(S.ABORTED, "Firestore shutting down"));
        }
      }
      function aQ() {
        return new nY((e) => nG(e), n$);
      }
      async function aH(e, t) {
        ...
        try {
          switch (n) {
            case 0:
              i.ea = await e.onListen(r, !0);
              break;
            case 1:
              i.ea = await e.onListen(r, !1);
              break;
            case 2:
              await e.onFirstRemoteStoreListen(r);
          }
        } catch (n) {
          let e = aB(n, `Initialization of query '${nj(t.query)}' failed`);
      ...
      function aZ(e, t, n) {
        ...
        if (r) for (let e of r.ta) e.onError(n);
        e.queries.delete(t);
      }
      function aJ(e) {
        e.ia.forEach((e) => {
      ...
      ((a = s || (s = {}))._a = "default"), (a.Cache = "cache");
      class aX {
        constructor(e, t, n) {
          (this.query = e),
            (this.aa = t),
      ...
      class a2 {
        ...
        ba(e, t) {
              ...
              u && h
                ? u.data.isEqual(h.data)
                  ...
                  : this.va(u, h) ||
                    ...
                    (f = !0),
                    ((o && this.ya(h, o) > 0) || (l && 0 > this.ya(h, l))) &&
                      (a = !0))
                : !u && h
          ...
          return { wa: s, Da: n, ls: a, mutatedKeys: i };
        }
        va(e, t) {
          return (
            e.hasLocalMutations &&
        ...
        Fa() {
          ...
          return (
            e.forEach((e) => {
              this.pa.has(e) || t.push(new a1(e));
            }),
            this.pa.forEach((n) => {
              e.has(n) || t.push(new a0(n));
            }),
            t
          );
        }
        Oa(e) {
          (this.fa = e.gs), (this.pa = n8());
      ...
      class a4 {
        constructor(e, t, n, r, i, s) {
          (this.localStore = e),
            ...
            (this.La = {}),
            (this.ka = new nY((e) => nG(e), n$)),
            (this.qa = new Map()),
            (this.Qa = new Set()),
            (this.$a = new tE(Q.comparator)),
            (this.Ka = new Map()),
            (this.Ua = new sh()),
            (this.Wa = {}),
            (this.Ga = new Map()),
      ...
      async function oe(e, t, n, r, i) {
        e.Ha = (t, n, r) =>
          (async function (e, t, n, r) {
            let i = t.view.ba(n);
            i.ls &&
              (i = await sO(e.localStore, t.query, !1).then(
            ...
            return of(e, t.targetId, o.Ma), o.snapshot;
          })(e, t, n, r);
        let s = await sO(e.localStore, t, !0),
          a = new a2(t, s.gs),
          o = a.ba(s.documents),
          l = rM.createSynthesizedTargetChangeForCurrentChange(
            n,
        ...
        e.isPrimaryClient
          ? (e.sharedClientState.removeLocalQueryTarget(r.targetId),
            e.sharedClientState.isActiveQueryTarget(r.targetId) ||
              (await sM(e.localStore, r.targetId, !1)
                .then(() => {
                  e.sharedClientState.clearQueryState(r.targetId),
                    n && ay(e.remoteStore, r.targetId),
                    oc(e, r.targetId);
                })
                .catch(es)))
          : (oc(e, r.targetId), await sM(e.localStore, r.targetId, !0));
      }
      async function on(e, t) {
        let n = e.ka.get(t),
          r = e.qa.get(n.targetId);
        e.isPrimaryClient &&
          1 === r.length &&
          (e.sharedClientState.removeLocalQueryTarget(n.targetId),
          ay(e.remoteStore, n.targetId));
      }
        ...
        try {
          ...
          let s = await (function (e, t) {
            ...
            return e.persistence
                      ...
                      let t = (function (e, t) {
                        ...
                        for (let r of e.fieldTransforms) {
                          let e = t.data.field(r.field),
                            i = re(r.transform, e || null);
                          null != i &&
                            (null === n && (n = na.empty()), n.set(r.field, i));
                        }
                        return n || null;
              ...
              .then(() => ({ batchId: r.batchId, changes: n0(n) }));
          })(r.localStore, t);
          r.sharedClientState.addPendingMutation(s.batchId),
            (i = s.batchId),
            (e = r.Wa[r.currentUser.toKey()]) || (e = new tE(P)),
            (e = e.insert(i, n)),
            (r.Wa[r.currentUser.toKey()] = e),
            await og(r, s.changes),
            await aD(r.remoteStore);
        } catch (t) {
          let e = aB(t, "Failed to persist write");
          n.reject(e);
        }
      }
          ...
          let n = await (function (e, t) {
            ...
            return e.persistence
              .runTransaction(
                ...
                "readwrite-primary",
                (i) => {
                  let s = e.ds.newChangeBuffer({ trackRemovals: !0 });
                  r = e.Ts;
                  let a = [];
                  t.targetChanges.forEach((s, o) => {
                    ...
                    if (!u) return;
                    a.push(
                      e.Hr.removeMatchingKeys(i, s.removedDocuments, o).next(
                        () => e.Hr.addMatchingKeys(i, s.addedDocuments, o),
                      ),
                    );
                    let h = u.withSequenceNumber(i.currentSequenceNumber);
                    null !== t.targetMismatches.get(o)
                      ? (h = h
                          .withResumeToken(tk.EMPTY_BYTE_STRING, B.min())
                      ...
                      (0 === u.resumeToken.approximateByteSize() ||
                        ...
                        s.addedDocuments.size +
                          ...
                          0) &&
                        a.push(e.Hr.updateTargetData(i, h));
                  });
                  let o = nZ,
                    l = n8();
                  if (
                    ...
                    a.push(
                      sR(i, s, t.documentUpdates).next((e) => {
                        (o = e.Vs), (l = e.fs);
                      }),
                    ),
                    !n.isEqual(B.min()))
                    ...
                    let t = e.Hr.getLastRemoteSnapshotVersion(i).next((t) =>
                      e.Hr.setTargetsMetadata(i, i.currentSequenceNumber, n),
                    );
                    a.push(t);
                  }
                  return ea
            ...
            r &&
              ...
              t.addedDocuments.size > 0
                ...
                : t.modifiedDocuments.size > 0
                  ? r.Ba || x()
                  : t.removedDocuments.size > 0 && (r.Ba || x(), (r.Ba = !1)));
          }),
            await og(e, n, t);
        } catch (e) {
          await es(e);
      ...
      async function oa(e, t, n) {
        ...
        let r = e.Ka.get(t),
          i = r && r.key;
        if (i) {
          let n = new tE(Q.comparator);
          n = n.insert(i, no.newNoDocument(i, B.min()));
          let r = n8().add(i),
            s = new rL(B.min(), new Map(), new tE(P), n, r);
          await oi(e, s), (e.$a = e.$a.remove(i)), e.Ka.delete(t), om(e);
        } else
          await sM(e.localStore, t, !1)
            .then(() => oc(e, t, n))
            .catch(es);
      }
      ...
      function of(e, t, n) {
        for (let r of n)
          r instanceof a0
            ? (e.Ua.addReference(r.key, t),
              (function (e, t) {
                let n = t.key,
                  r = n.path.canonicalString();
                e.$a.get(n) ||
                  e.Qa.has(r) ||
                  (T(a5, "New document in limbo: " + n), e.Qa.add(r), om(e));
              })(e, r))
            : r instanceof a1
              ? (T(a5, "Document no longer in limbo: " + r.key),
                e.Ua.removeReference(r.key, t),
                e.Ua.containsKey(r.key) || od(e, r.key))
              : x();
      }
      function om(e) {
        for (; e.Qa.size > 0 && e.$a.size < e.maxConcurrentLimboResolutions; ) {
          ...
          e.Qa.delete(t);
          let n = new Q($.fromString(t)),
            r = e.za.next();
          e.Ka.set(r, new a3(n)),
            (e.$a = e.$a.insert(n, r)),
            ap(
              e.remoteStore,
              new io(nB(nF(n.path)), r, "TargetPurposeLimboResolution", eT.ae),
            );
        }
      }
        ...
        e.ka.isEmpty() ||
          ...
          await (async function (e, t) {
            try {
              ...
              if (!ef(e)) throw e;
              T(sD, "Failed to update sequence numbers: " + e);
            }
            for (let n of t) {
              let t = n.targetId;
              if (!n.fromCache) {
      ...
      async function op(e, t) {
        ...
        if (!e.currentUser.isEqual(t)) {
          T(a5, "User change. New user:", t.toKey());
          let r = await sA(e.localStore, t);
          (e.currentUser = t),
            (n =
              "'waitForPendingWrites' promise is rejected due to a user change."),
            e.Ga.forEach((e) => {
              e.forEach((e) => {
                e.reject(new N(S.CANCELLED, n));
              });
            }),
            e.Ga.clear(),
      ...
      function oy(e, t) {
        ...
        if (n && n.Ba) return n8().add(n.key);
        {
          ...
          for (let t of r) {
            let r = e.ka.get(t);
            n = n.unionWith(r.view.Sa);
          }
          return n;
        }
      }
      async function ow(e, t) {
        let n = await sO(e.localStore, t.query, !0),
          r = t.view.Oa(n);
        return e.isPrimaryClient && of(e, t.targetId, r.Ma), r;
      }
      async function ov(e, t) {
        return sP(e.localStore, t).then((t) => og(e, t));
      }
          ...
          return e.persistence.runTransaction(
            ...
            (r) =>
              n
                .Ln(r, t)
                .next((t) =>
                  t ? e.localDocuments.getDocuments(r, t) : ea.resolve(null),
                ),
          );
        })(e.localStore, t);
        null !== i
          ? ("pending" === n
              ? await aD(e.remoteStore)
              : "acknowledged" === n || "rejected" === n
                ? (oh(e, t, r || null),
                  ou(e, t),
                  (function (e, t) {
                    e.mutationQueue.qn(t);
                  })(e.localStore, t))
                : x(),
            await og(e, i))
          : T(a5, "Cannot apply mutation batch with id: " + t);
      }
      async function oT(e, t) {
        if ((oN(e), oC(e), !0 === t && !0 !== e.ja)) {
          let t = e.sharedClientState.getAllActiveQueryTargets(),
            n = await oE(e, t.toArray());
          for (let t of ((e.ja = !0), await aF(e.remoteStore, !0), n))
            ap(e.remoteStore, t);
        } else if (!1 === t && !1 !== e.ja) {
          let t = [],
            n = Promise.resolve();
          e.qa.forEach((r, i) => {
            e.sharedClientState.isLocalQueryTarget(i)
              ? t.push(i)
              : (n = n.then(() => (oc(e, i), sM(e.localStore, i, !0)))),
              ay(e.remoteStore, i);
          }),
            await n,
            await oE(e, t),
            ...
            e.Ua.Dr(),
            (e.Ka = new Map()),
            (e.$a = new tE(Q.comparator)),
            (e.ja = !1),
            await aF(e.remoteStore, !1);
        }
      }
      async function oE(e, t, n) {
        ...
        for (let n of t) {
          ...
          let s = e.qa.get(n);
          if (s && 0 !== s.length)
            for (let n of ((t = await sL(e.localStore, nB(s[0]))), s)) {
              let t = e.ka.get(n),
                r = await ow(e, t);
              r.snapshot && i.push(r.snapshot);
            }
          else {
            let r = await sF(e.localStore, n);
            (t = await sL(e.localStore, r)),
              await oe(e, o_(r), n, !1, t.resumeToken);
          }
          r.push(t);
        }
        return e.La.p_(i), r;
      ...
      function o_(e) {
        ...
        return (
          ...
          (r = e.orderBy),
          (i = e.filters),
          new nO(t, n, r, i, e.limit, "F", e.startAt, e.endAt)
        );
      }
      function ob(e) {
        return e.localStore.persistence.zi();
      }
      async function ox(e, t, n, r) {
        if (e.ja)
          return void T(a5, "Ignoring unexpected query state notification.");
        let i = e.qa.get(t);
        if (i && i.length > 0)
          switch (n) {
            case "current":
            case "not-current": {
              let r = await sP(e.localStore, nH(i[0])),
                s = rL.createSynthesizedRemoteEventForCurrentChange(
                  t,
                  "current" === n,
                  tk.EMPTY_BYTE_STRING,
                );
            ...
            case "rejected":
              await sM(e.localStore, t, !0), oc(e, t, r);
              break;
            default:
              x();
          }
        ...
        if (r.ja) {
          for (let e of t) {
            if (r.qa.has(e) && r.sharedClientState.isActiveQueryTarget(e)) {
              T(a5, "Adding an already active target " + e);
              continue;
            }
            let t = await sF(r.localStore, e),
              n = await sL(r.localStore, t);
            await oe(r, o_(t), n.targetId, !1, n.resumeToken),
              ap(r.remoteStore, n);
          }
          for (let e of n)
            r.qa.has(e) &&
              (await sM(r.localStore, e, !1)
                .then(() => {
                  ay(r.remoteStore, e), oc(r, e);
                })
                .catch(es));
        }
      }
      function oN(e) {
        return (
          (e.remoteStore.remoteSyncer.applyRemoteEvent = oi.bind(null, e)),
          (e.remoteStore.remoteSyncer.getRemoteKeysForTarget = oy.bind(
            null,
            e,
          )),
          (e.remoteStore.remoteSyncer.rejectListen = oa.bind(null, e)),
          (e.La.p_ = aY.bind(null, e.eventManager)),
          (e.La.Ja = aZ.bind(null, e.eventManager)),
          e
        );
      }
      function oC(e) {
        return (
          (e.remoteStore.remoteSyncer.applySuccessfulWrite = oo.bind(null, e)),
          (e.remoteStore.remoteSyncer.rejectFailedWrite = ol.bind(null, e)),
          e
        );
      }
      class oD {
        ...
        async initialize(e) {
          (this.serializer = ar(e.databaseInfo.databaseId)),
        ...
        eu(e) {
          ...
          return (
            (t = this.persistence),
            new sk(t, new sC(), e.initialUser, this.serializer)
          );
        }
        Xa(e) {
          return new sp(sw.ri, this.serializer);
        }
        Za(e) {
          return new sX();
        }
      ...
      class ok extends oD {
        ...
        tu(e, t) {
          return (
            this.persistence.referenceDelegate instanceof sv || x(),
            new i3(
        ...
        Xa(e) {
          let t =
            void 0 !== this.cacheSizeBytes
              ? iQ.withCacheSize(this.cacheSizeBytes)
              : iQ.DEFAULT;
          return new sp((e) => sv.ri(e, t), this.serializer);
        }
      }
      class oA extends oD {
        constructor(e, t, n) {
        ...
        async initialize(e) {
          await super.initialize(e),
            await this.ru.initialize(this, e),
            await oC(this.ru.syncEngine),
            await aD(this.ru.remoteStore),
            await this.persistence.Ci(
              () => (
                this.gcScheduler &&
        ...
        nu(e, t) {
          let n = new eI(t, this.persistence);
          return new ev(e.asyncQueue, n);
        }
        Xa(e) {
          let t = sx(e.databaseInfo.databaseId, e.databaseInfo.persistenceKey),
            n =
              void 0 !== this.cacheSizeBytes
                ? iQ.withCacheSize(this.cacheSizeBytes)
                : iQ.DEFAULT;
      ...
      class oV {
        async initialize(e, t) {
          this.localStore ||
            ...
            (this.sharedClientState.onlineStateHandler = (e) =>
              os(this.syncEngine, e, 1)),
            (this.remoteStore.remoteSyncer.handleCredentialChange = op.bind(
              null,
              this.syncEngine,
            )),
            await aF(this.remoteStore, this.syncEngine.isPrimaryClient));
        }
        createEventManager(e) {
          return new aj();
        }
        createDatastore(e) {
          let t = ar(e.databaseInfo.databaseId),
            n = new ae(e.databaseInfo);
          return new ah(e.authCredentials, e.appCheckCredentials, n, t);
        }
        createRemoteStore(e) {
          var t;
          return (
        ...
        async terminate() {
          var e, t;
          await (async function (e) {
            T(ad, "RemoteStore shutting down."),
              e.W_.add(5),
              await ag(e),
              e.z_.shutdown(),
              e.j_.set("Unknown");
        ...
        constructor(e, t, n, r, i) {
          (this.authCredentials = e),
            ...
            this.appCheckCredentials.start(
              n,
              (e) => (
                T(oL, "Received new app check token=", e),
          ...
          return (
            this.asyncQueue.enqueueAndForgetEvenWhileRestricted(async () => {
              try {
                ...
                let t = aB(n, "Failed to shutdown persistence");
                e.reject(t);
              }
            }),
            e.promise
      ...
      async function oO(e, t) {
        e.asyncQueue.verifyOperationInProgress(),
          T(oL, "Initializing OfflineComponentProvider");
      ...
      async function oF(e, t) {
        e.asyncQueue.verifyOperationInProgress();
        let n = await oP(e);
        T(oL, "Initializing OnlineComponentProvider"),
          await t.initialize(n, e.configuration),
          e.setCredentialChangeListener((e) => aO(t.remoteStore, e)),
          e.setAppCheckTokenChangeListener((e, n) => aO(t.remoteStore, n)),
          (e._onlineComponents = t);
      }
      async function oP(e) {
        if (!e._offlineComponents) {
          if (e._uninitializedComponentsProvider) {
            T(oL, "Using user provided OfflineComponentProvider");
            try {
              await oO(e, e._uninitializedComponentsProvider._offline);
            } catch (t) {
              if (
            ...
            T(oL, "Using default OfflineComponentProvider"),
              await oO(e, new ok(void 0));
        }
        ...
        return (
          e._onlineComponents ||
            (e._uninitializedComponentsProvider
              ? (T(oL, "Using user provided OnlineComponentProvider"),
                await oF(e, e._uninitializedComponentsProvider._online))
              : (T(oL, "Using default OnlineComponentProvider"),
                await oF(e, new oV()))),
          e._onlineComponents
        );
      }
      async function oq(e) {
        let t = await oU(e),
          n = t.eventManager;
        return (
          (n.onListen = a6.bind(null, t.syncEngine)),
          (n.onUnlisten = ot.bind(null, t.syncEngine)),
          (n.onFirstRemoteStoreListen = a9.bind(null, t.syncEngine)),
          (n.onLastRemoteStoreUnlisten = on.bind(null, t.syncEngine)),
          n
        );
      }
      function oB(e) {
      ...
      function oj(e) {
        ...
        return "function" == typeof e ? "a function" : x();
      }
      function oQ(e, t) {
      ...
      let oH = "firestore.googleapis.com";
      class oW {
        constructor(e) {
          var t, n;
          if (void 0 === e.host) {
            ...
            this.experimentalForceLongPolling
              ...
              : void 0 === e.experimentalAutoDetectLongPolling
                ...
                : (this.experimentalAutoDetectLongPolling =
                    !!e.experimentalAutoDetectLongPolling),
            (this.experimentalLongPollingOptions = oB(
      ...
      class oZ {
        ...
        withConverter(e) {
          return new oZ(this.firestore, e, this._query);
        }
      }
      class oJ {
        constructor(e, t, n) {
        ...
        withConverter(e) {
          return new oJ(this.firestore, e, this._key);
        }
      }
      class oX extends oZ {
        constructor(e, t, n) {
          super(e, t, nF(n)), (this._path = n), (this.type = "collection");
        }
        get id() {
        ...
        get parent() {
          ...
          return e.isEmpty() ? null : new oJ(this.firestore, null, new Q(e));
        }
        withConverter(e) {
      ...
      function o0(e, t, ...n) {
        if (
          ((e = (0, h.Ku)(e)), oz("collection", "path", t), e instanceof oY)
        ) {
          let r = $.fromString(t, ...n);
          return oG(r), new oX(e, null, r);
        }
        {
          if (!(e instanceof oJ || e instanceof oX))
            throw new N(
              S.INVALID_ARGUMENT,
              "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore",
            );
          let r = e._path.child($.fromString(t, ...n));
          return oG(r), new oX(e.firestore, null, r);
        }
      }
      let o1 = "AsyncQueue";
      class o2 {
        constructor(e = Promise.resolve()) {
          (this.Vu = []),
            ...
            (this.yu = !1),
            (this.wu = []),
            (this.a_ = new ai(this, "async_queue_retry")),
            (this.Su = () => {
              let e = an();
              e && T(o1, "Visibility state changed to " + e.visibilityState),
                this.a_.t_();
            }),
            (this.bu = e);
          let t = an();
        ...
        async Cu() {
          if (0 !== this.Vu.length) {
            try {
              ...
              if (!ef(e)) throw e;
              T(o1, "Operation failed with retryable error: " + e);
            }
        ...
        enqueueAfterDelay(e, t, n) {
          ...
          let r = aq.createAndSchedule(this, e, t, n, (e) => this.Fu(e));
      ...
      function o8(e, t) {
        let n = "object" == typeof e ? e : (0, o.Sx)(),
          r = (0, o.j6)(n, "firestore").getImmediate({
            identifier: "string" == typeof e ? e : t || tz,
          });
        if (!r._initialized) {
          ...
          e &&
            (function (e, t, n, r = {}) {
              ...
              if (
                ...
                e._authCredentials = new A(new D(t, n));
              }
            })(r, ...e);
        }
        return r;
              ...
              let s = e._freezeSettings(),
                a =
                  ...
                  new tK(
                    ...
                    oB(s.experimentalLongPollingOptions),
                    s.useFetchStreams,
                  ));
      ...
      class o4 {
        ...
        static fromBase64String(e) {
          try {
            return new o4(tk.fromBase64String(e));
          } catch (e) {
            throw new N(
              S.INVALID_ARGUMENT,
        ...
        static fromUint8Array(e) {
          return new o4(tk.fromUint8Array(e));
        }
        toBase64() {
      ...
      class ln {
        ...
        toMutation(e, t) {
          return null !== this.fieldMask
            ? new rw(e, this.data, this.fieldMask, t, this.fieldTransforms)
            : new ry(e, this.data, t, this.fieldTransforms);
        }
      }
      class lr {
        constructor(e, t, n) {
        ...
        toMutation(e, t) {
          return new rw(e, this.data, this.fieldMask, t, this.fieldTransforms);
        }
      }
      function li(e) {
        switch (e) {
      ...
      class la {
        constructor(e, t, n) {
          (this.databaseId = e),
            ...
            (this.serializer = n || ar(e));
        }
        ju(e, t, n, r = !1) {
          return new ls(
            { Lu: e, methodName: t, zu: n, path: j.emptyPath(), Qu: !1, Gu: r },
            this.databaseId,
            this.serializer,
            this.ignoreUndefinedProperties,
          );
      ...
      function lo(e) {
        let t = e._freezeSettings(),
          n = ar(e._databaseId);
        return new la(e._databaseId, !!t.ignoreUndefinedProperties, n);
      }
      function ll(e, t, n, r, i, s = {}) {
        let a, o;
        let l = e.ju(s.merge || s.mergeFields ? 2 : 0, t, n, i);
        lv("Data must be an object, but it was:", l, r);
        let u = ly(r, l);
        if (s.merge) (a = new tC(l.fieldMask)), (o = l.fieldTransforms);
      ...
      function lh(e, t, n) {
        return new ls(
          { Lu: 3, zu: t.settings.zu, methodName: e._methodName, Qu: n },
          t.databaseId,
          t.serializer,
      ...
      class ld extends o9 {
        ...
        _toFieldTransform(e) {
          let t = lh(this, e, !0),
            n = new rn(this.Hu.map((e) => lp(e, t)));
          return new ru(e.path, n);
        }
        isEqual(e) {
          return e instanceof ld && (0, h.bD)(this.Hu, e.Hu);
        }
      }
      class lf extends o9 {
        constructor(e, t) {
        ...
        _toFieldTransform(e) {
          let t = lh(this, e, !0),
            n = new ri(this.Hu.map((e) => lp(e, t)));
          return new ru(e.path, n);
        }
        isEqual(e) {
          return e instanceof lf && (0, h.bD)(this.Hu, e.Hu);
        }
      }
      class lm extends o9 {
        constructor(e, t) {
        ...
        _toFieldTransform(e) {
          let t = new ra(e.serializer, n9(e.serializer, this.Ju));
          return new ru(e.path, t);
        }
        isEqual(e) {
          return e instanceof lm && this.Ju === e.Ju;
        }
      }
      function lg(e, t, n, r = !1) {
        return lp(n, e.ju(r ? 4 : 3, t));
      }
      function lp(e, t) {
        if (lw((e = (0, h.Ku)(e))))
          return lv("Unsupported field value:", t, e), ly(e, t);
        if (e instanceof o9)
          return (
            (function (e, t) {
              if (!li(t.Lu))
        ...
        return (function (e, t) {
          ...
          if ("number" == typeof e) return n9(t.serializer, e);
          if ("boolean" == typeof e) return { booleanValue: e };
          if ("string" == typeof e) return { stringValue: e };
          if (e instanceof Date) {
            let n = q.fromDate(e);
            return { timestampValue: rH(t.serializer, n) };
          }
          if (e instanceof q) {
            let n = new q(e.seconds, 1e3 * Math.floor(e.nanoseconds / 1e3));
            return { timestampValue: rH(t.serializer, n) };
          }
          if (e instanceof o7)
            return {
          ...
          if (e instanceof o4)
            return { bytesValue: rW(t.serializer, e._byteString) };
          if (e instanceof oJ) {
            let n = t.databaseId,
          ...
          throw t.Wu(`Unsupported field value: ${oj(e)}`);
        })(e, t);
      }
      function ly(e, t) {
        let n = {};
      ...
      function lI(e, t, n) {
        if ((t = (0, h.Ku)(t)) instanceof o6) return t._internalPath;
        if ("string" == typeof t) return lE(e, t);
        throw l_(
      ...
      function lE(e, t, n) {
        ...
        try {
          return new o6(...t.split("."))._internalPath;
        } catch (r) {
          throw l_(
      ...
      function l_(e, t, n, r, i) {
        ...
        return (
          (s || a) &&
            ...
            a && (l += ` in document ${i}`),
            (l += ")")),
          new N(S.INVALID_ARGUMENT, o + e + l)
        );
      }
      function lb(e, t) {
      ...
      class lx {
        ...
        get ref() {
          return new oJ(this._firestore, this._converter, this._key);
        }
        exists() {
        ...
        get(e) {
          if (this._document) {
            let t = this._document.data.field(lN("DocumentSnapshot.get", e));
      ...
      class lk extends lD {
        ...
        _apply(e) {
          let t = this._parse(e);
          return (
            lU(e._query, t), new oZ(e.firestore, e.converter, nK(e._query, t))
          );
        }
        _parse(e) {
          let t = lo(e.firestore);
          return (function (e, t, n, r, i, s, a) {
            let o;
            if (i.isKeyField()) {
              ...
              if ("in" === s || "not-in" === s) {
                lP(a, s);
                let t = [];
                for (let n of a) t.push(lF(r, e, n));
                o = { arrayValue: { values: t } };
              } else o = lF(r, e, a);
            } else
              ("in" !== s && "not-in" !== s && "array-contains-any" !== s) ||
                lP(a, s),
                (o = lg(n, t, a, "in" === s || "not-in" === s));
            return nf.create(i, s, o);
          })(
            e._query,
            "where",
            t,
      ...
      class lA extends lC {
        ...
        _parse(e) {
          ...
          return 1 === t.length ? t[0] : nm.create(t, this._getOperator());
        }
        _apply(e) {
          let t = this._parse(e);
          return 0 === t.getFilters().length
            ...
            : ((function (e, t) {
                let n = e;
                for (let e of t.getFlattenedFilters()) lU(n, e), (n = nK(n, e));
              })(e._query, t),
              new oZ(e.firestore, e.converter, nK(e._query, t)));
        }
      ...
      class lR extends lD {
        ...
        _apply(e) {
          return new oZ(
            e.firestore,
            e.converter,
            nz(e._query, this._limit, this._limitType),
          );
        }
      }
      class lL extends lD {
        ...
        _apply(e) {
          var t;
          let n = lO(e, this.type, this._docOrFields, this._inclusive);
          return new oZ(
            e.firestore,
            e.converter,
            new nO(
      ...
      function lO(e, t, n, r) {
        if (((n[0] = (0, h.Ku)(n[0])), n[0] instanceof lx))
          return (function (e, t, n, r, i) {
            ...
            let s = [];
            for (let n of nq(e))
              if (n.field.isKeyField()) s.push(t8(t, r.key));
              else {
      ...
      function lF(e, t, n) {
        ...
        if (n instanceof oJ) return t8(e, n._key);
        throw new N(
          S.INVALID_ARGUMENT,
          `Invalid query. When querying with documentId(), you must provide a valid string or a DocumentReference, but it was: ${oj(n)}.`,
        );
      }
      function lP(e, t) {
      ...
      class lq {
        convertValue(e, t = "none") {
          switch (tZ(e)) {
            ...
            case 6:
              return this.convertBytes(tL(e.bytesValue));
            case 7:
                ...
                null ===
                  (n =
                    null === (t = e.fields) || void 0 === t
                      ? void 0
                      : t[tW].arrayValue) || void 0 === n
                  ? void 0
                  : n.values) || void 0 === r
              ? void 0
              : r.map((e) => tR(e.doubleValue)),
          );
        }
        convertGeoPoint(e) {
          return new o7(tR(e.latitude), tR(e.longitude));
        }
        convertArray(e, t) {
        ...
        convertServerTimestamp(e, t) {
          switch (t) {
            ...
            case "estimate":
              return this.convertTimestamp(tB(e));
            default:
              return null;
          }
        }
      ...
      class lK extends lq {
        ...
        convertReference(e) {
          ...
          return new oJ(this.firestore, null, t);
        }
      }
      class lz {
        constructor(e, t) {
      ...
      class l$ extends lx {
        ...
        get(e, t = {}) {
          if (this._document) {
            let n = this._document.data.field(lN("DocumentSnapshot.get", e));
            if (null !== n)
      ...
      class lj {
        constructor(e, t, n, r) {
          (this._firestore = e),
            (this._userDataWriter = t),
            (this._snapshot = r),
            (this.metadata = new lz(r.hasPendingWrites, r.fromCache)),
            (this.query = n);
        }
        get docs() {
          let e = [];
                  ...
                  return e._snapshot.docChanges
                    ...
                    .map((t) => {
                      ...
                      return (
                        ...
                        1 !== t.type &&
                          (s = (n = n.add(t.doc)).indexOf(t.doc.key)),
                        {
                          type: (function (e) {
                            switch (e) {
                              case 0:
              ...
              e.asyncQueue.enqueueAndForget(async () =>
                (function (e, t, n, r, i) {
                  let s = new oR({
                    ...
                    a = new aX(n, s, { includeMetadataChanges: !0, Ta: !0 });
                  return aH(e, a);
                })(await oq(e), e.asyncQueue, t, n, r),
              ),
              r.promise
            );
          })(n, e._query).then((n) => new lj(t, r, e, n))
        );
      }
      function lW(e, t) {
        var n, r;
        let i = oQ(e.firestore, o5),
          s = (function (e, t, ...n) {
            if (
              ((e = (0, h.Ku)(e)),
              1 == arguments.length && (t = F.newId()),
              oz("doc", "path", t),
              e instanceof oY)
            ) {
              let r = $.fromString(t, ...n);
              return o$(r), new oJ(e, null, new Q(r));
            }
            {
              if (!(e instanceof oJ || e instanceof oX))
                throw new N(
              ...
              return (
                ...
                new oJ(
                  e.firestore,
                  e instanceof oX ? e.converter : null,
                  new Q(r),
                )
              );
            }
        ...
        (r = [
          ll(
            ...
            null !== e.converter,
            {},
          ).toMutation(s._key, rc.exists(!1)),
        ]),
        (function (e, t) {
          let n = new C();
          return (
            e.asyncQueue.enqueueAndForget(async () =>
              or(await oU(e).then((e) => e.syncEngine), t, n),
            ),
            n.promise
          );
        })(o3(n), r)).then(() => s);
              ...
              new l.uA(
                ...
                (t, { instanceIdentifier: n, options: r }) => {
                  let i = t.getProvider("app").getImmediate(),
                    s = new o5(
                      new V(t.getProvider("auth-internal")),
                      new O(i, t.getProvider("app-check-internal")),
                      (function (e, t) {
                        if (
                        ...
                        return new t$(e.options.projectId, t);
                      })(i, n),
                      i,
                    );
                  return (
