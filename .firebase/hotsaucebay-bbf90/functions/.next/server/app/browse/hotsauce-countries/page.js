    ...
    (e.modules = {
        ...
        let b = [
                  ...
                  children: [
                    "hotsauce-countries",
                    {
                      children: [
                        ...
                        {
                          page: [
                            () => Promise.resolve().then(l.bind(l, 19941)),
                            "/Users/kaspars/Desktop/hotsaucebay/app/browse/hotsauce-countries/page.tsx",
                          ],
                        },
                      ],
                    },
          ...
          y = new r.AppPageRouteModule({
            definition: {
              ...
              page: "/browse/hotsauce-countries/page",
              pathname: "/browse/hotsauce-countries",
              bundlePath: "",
              filename: "",
              appPaths: [],
            },
      ...
      19941: (e, a, l) => {
        ...
        async function n() {
          return (0, r.jsxs)("div", {
            children: [
              (0, r.jsx)("h1", { className: "text-xl", children: "Countries" }),
              s.X.map((e) =>
                (0, r.jsx)(
                  "div",
                  {
                    children: (0, r.jsx)(i.Link, {
                      href: `/hotsauce-country/${e.key}`,
                      children: e.label,
                    }),
                  },
                  e.key,
