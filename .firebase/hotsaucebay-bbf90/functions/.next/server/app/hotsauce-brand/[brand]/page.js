(() => {
  ...
  (e.id = 623),
    ...
    (e.modules = {
        ...
        let b = [
                  ...
                  children: [
                    "[brand]",
                    {
                      children: [
                        ...
                        {
                          page: [
                            () => Promise.resolve().then(r.bind(r, 90847)),
                            "/Users/kaspars/Desktop/hotsaucebay/app/hotsauce-brand/[brand]/page.tsx",
                          ],
                        },
                      ],
                    },
          ...
          p = new s.AppPageRouteModule({
            definition: {
              ...
              page: "/hotsauce-brand/[brand]/page",
              pathname: "/hotsauce-brand/[brand]",
              bundlePath: "",
              filename: "",
              appPaths: [],
            },
      ...
      90847: (e, a, r) => {
        "use strict";
        r.r(a), r.d(a, { default: () => b, generateMetadata: () => o });
        var s = r(62740),
          t = r(56409),
          l = r(692),
          i = r(6499),
        ...
        async function o({ params: e }) {
          let { brand: a } = await e,
            r = t.H.find((e) => e.key === a);
          return {
            title: `Hot sauces from ${r?.label}`,
            description: `Find the best hotsauces from ${r?.label}`,
          };
        }
        async function b({ params: e }) {
          let { brand: a } = await e,
            r = t.H.find((e) => e.key === a),
            o = (0, n.rJ)(l.db, "products"),
            b = (0, n.P)(o, (0, n._M)("brand", "==", r)),
            d = (await (0, n.GG)(b)).docs.map((e) => e.data());
          return (0, s.jsxs)("div", {
            children: [
              (0, s.jsxs)("h1", {
                className: "text-xl",
                children: ["Hotsauces by ", r?.label],
              }),
              d.map((e, a) => (0, s.jsx)(i.A, { sauce: e }, a)),
            ],
          });
        }
      },
